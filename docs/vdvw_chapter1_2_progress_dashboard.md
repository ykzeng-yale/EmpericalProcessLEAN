...
`coverRadius n = 1 / (n + 1)`. The remaining blocker is deriving or supplying
the diagonal entropy/cardinality hypotheses, measurable cardinality, and
boundedness/UI or dominated-convergence for that route, then final assembly.
