...
Gaussian-limit/theta0-section coordinate covariance equality,
...
endpoint. Prefer either an observation-level empirical estimating-equation root
source or a direct observation-estimating-map theta0 moment source; the
sample-indexed estimating-map plumbing, separate score-transform map, and
direct covariance equality are solved and should not be replayed. Reuse local
...
endpoint packages that equality from centered products.
