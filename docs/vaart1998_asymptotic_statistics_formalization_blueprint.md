...
- `MEstimators.lean`: Chapter 5 M/Z-estimator consistency and asymptotic
  ...
  canonical, projected, common-vector-law, score-representation,
  derivative-bound, finite-strong-law, and action-bound law-tail wrappers by
  calling this absorbing derivative-norm endpoint, or move to a genuinely
