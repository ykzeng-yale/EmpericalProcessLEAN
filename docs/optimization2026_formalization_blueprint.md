...
closure/envelope.  The compact bridge reuses Mathlib
`IsCompact.bddAbove_image`, `BddAbove.mono`, `Set.image_mono`, and coordinate
continuity from `PiLp.continuous_apply`.  The remaining scalar comparison is
against the coordinate `sSup`.
