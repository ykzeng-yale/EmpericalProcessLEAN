...
The current blocker plan contains `Live In-Thread Goal Prompt V594`, the live
`/goal` replacement prompt.  Use it when the app-level objective is older than
the verified route docs; do not create a duplicate goal or recurring
automation.

Current immediate target after V594: stay on Durrett Theorem 2.4.9
...
final-display source wrapper not already covered by V500-V594,
