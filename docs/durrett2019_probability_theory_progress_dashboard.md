...
Route from `Live In-Thread Goal Prompt V209` in
...
The next target is the deterministic integral comparison for `b_n = f(A_n)`,
using V204-V209 as closed support.
