...
| 2.1.5 covering numbers | `..._1-100.md:1894` | abstract local interface only |
...
| 1.2.3 | Lemma | `..._1-100.md:438` | local-layer: outer/inner event probability, explicit measurable event-cover existence, arbitrary measurable set cover to event-indicator cover, event lower-indicator lower cover, inner-expectation indicator equality, and two-sided complement expectation identities |
...
| 2.4.3 | Theorem | `..._101-200.md:988` | pending-local |
