...
Latest verified packet: absolute-envelope source endpoint for the
...
Immediate predecessor packet: unscaled score source endpoint for the
score-at-theta0/Taylor route, including
...
Current next blocker: continue from the absolute-envelope unscaled-score
