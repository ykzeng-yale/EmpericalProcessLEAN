...
Route from `Live In-Thread Goal Prompt V87` in
...
zero-set-not-full positive-branch eliminator also now compile.  The next
target is the concrete zero-set tail-measurability/non-full endpoints and
