...
Immediate predecessor packet: coordinate score moment source endpoint for the
...
It replaces vector-valued score `L²` by coordinatewise score-transform `L²`
assumptions and derives the vector moment with `MemLp.of_eval`.
