...
Latest verified packet: derivative-transform law-integrability source endpoint
...
Immediate predecessor packet: score-transform law `L²` source endpoint for the
