...
| 1.2.3 | Lemma | `..._1-100.md:438` | local-layer: outer/inner event probability, event lower-indicator lower cover, inner-expectation indicator equality, and complement expectation identity |
