...
## Live In-Thread Goal Prompt V579
...
Latest verified target V579 adds canonical iid product-coordinate Chapter
...
These wrappers let product-expectation consumers start from the canonical
infinite product coordinate process already used by Theorem 2.4.9 without
reopening product-coordinate independence or coordinate-law proofs.
Next target:
...
Use `Live In-Thread Goal Prompt V579` at the top of this file.  Historical route
