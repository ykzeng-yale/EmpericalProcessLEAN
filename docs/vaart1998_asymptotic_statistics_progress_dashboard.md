...
Latest verified packet: law-side score second-moment source endpoint for the
...
Immediate predecessor packet: score-vector coordinate mean source endpoint for
