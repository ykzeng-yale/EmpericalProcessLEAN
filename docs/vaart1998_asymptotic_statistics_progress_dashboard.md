...
Latest verified packet: joint-measurability source endpoint for the
...
Immediate predecessor packet: absolute-envelope source endpoint for the
score-at-theta0/Taylor route, including
...
`|envelope x|` and feeding the previous endpoint the absolute envelope.
...
Current next blocker: continue from the joint-measurability absolute-envelope
