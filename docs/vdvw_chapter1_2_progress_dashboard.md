...
READY      Definition 2.1.5 covering-number primitive plus fixed-sample/random empirical L1(P_n) entropy, F_M truncation interfaces, fixed-sample empirical-net inequality (2.4.4), and finite-center maximal/Hoeffding-scale handoff layer for Theorem 2.4.3 setup.
