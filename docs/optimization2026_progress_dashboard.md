...
Next high-value task: Chewi Proposition 2.7(2), the PL-to-quadratic-growth
route used in the notes.  Continue with Corollary 2.8 afterward.  Do not spend
proof runs on exercise derivations until the main theorem lane is covered.
