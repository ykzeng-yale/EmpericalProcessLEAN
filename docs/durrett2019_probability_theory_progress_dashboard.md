...
Route from `Live In-Thread Goal Prompt V34` in
...
convergence's explicit Fatou expectation inequality; the convergence and
integrable-limit components now compile.
...
wrappers, and Theorem 4.2.12 nonnegative-supermartingale convergence plus
integrable-limit wrappers.
...
Next proof packet: finish Theorem 4.2.12 by adding the Fatou expectation bridge
`E X ≤ E X_0` for the compiled nonnegative-supermartingale limit.
