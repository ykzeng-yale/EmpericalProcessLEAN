...
Latest verified packet: law-side score coordinate-mean source endpoint for the
...
Immediate predecessor packet: law-side score second-moment source endpoint for
