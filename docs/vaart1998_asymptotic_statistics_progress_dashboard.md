...
Latest verified packet: vector score-transform `L²` source
...
Immediate predecessor packet: Gaussian-limit/score-law coordinate covariance source
endpoint for the score-at-theta0/Taylor route, including
...
Current next blocker: continue from the vector score-transform `L²`
