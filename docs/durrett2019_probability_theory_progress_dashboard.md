...
Route from `Live In-Thread Goal Prompt V265` in
...
The next target is full probability `UniformIntegrable` packaging for the
reverse implication if cheap; otherwise move to Lemma 4.6.5, Lemma 4.6.6, and
Theorem 4.6.7.
V259
