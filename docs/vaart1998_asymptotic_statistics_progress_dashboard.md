...
Move next to the actual estimating-map coordinate path wrapper and remove its
`hScaledEstimator` hypothesis by calling the absorbing coordinate path Taylor
