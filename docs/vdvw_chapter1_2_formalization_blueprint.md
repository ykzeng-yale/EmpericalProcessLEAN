...
3. Promote Chapter 2 primitive infrastructure: covering/packing semimetric
   ...
   The next frontier is proving the measurable-cover outer-expectation transfer
   for the theorem-local `hphi_id`, then entropy-to-convergence and final
   assembly.
