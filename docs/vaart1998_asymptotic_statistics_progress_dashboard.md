...
Move next to the actual estimating-map Frechet-derivative path wrapper and
remove its `hScaledEstimator` hypothesis by calling the absorbing actual
estimating-map path endpoint, or prove the next genuinely model-specific
