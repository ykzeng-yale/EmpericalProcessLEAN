...
Route from `Live In-Thread Goal Prompt V219` in
...
The next target is to remove remaining non-integrability side conditions,
especially interval integrability of `fun t => (f t)⁻¹ ^ 2` and normalizer
