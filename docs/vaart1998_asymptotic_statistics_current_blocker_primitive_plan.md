...
1. Move one layer closer to a model-facing finite-dimensional statement:
   continue from the Gaussian-limit coordinate-measurability fixed-`theta0` endpoint toward a concrete
...
coordinate-measurability source endpoint for Vaart Theorem 5.41.
...
Gaussian-limit coordinate-measurability endpoint to a concrete
