...
This endpoint replaces coordinate derivative-transform integrability fields by
vector-valued derivative-transform integrability and derives each matrix-entry
integrability field internally with `Integrable.eval`.
...
1. Move one layer closer to a model-facing finite-dimensional statement:
   connect the derivative-transform vector integrability endpoint to a concrete
