...
- Current manual frontier after the 2026-05-05 standard-cut scalar,
  ...
  cores, coordinate-free normalized half-space containment, and abstract
  affine-transport certificate bridge compile in
...
`chewi620_affineTransport_stepCertificate_of_quadratic`.  The next manual goal
packet should instantiate the displayed matrix update hypotheses of that
certificate using mathlib matrix/PSD/determinant/inverse/volume APIs.  If the
