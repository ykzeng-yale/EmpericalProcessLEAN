...
Immediate predecessor packet: coordinate score-measurability source endpoint for the
...
Current next blocker: continue from the derivative-transform coordinate-measurability
