...
Move next to the `theta0`-specialized Frechet vector Taylor wrapper and remove
its `hScaledEstimator` hypothesis by calling the absorbing vector-continuity
