...
Route from `Live In-Thread Goal Prompt V123` in
...
The next target is Durrett Theorem 4.4.6, the `L^p` convergence theorem, using
compiled Theorem 4.2.11 convergence plus the completed Theorem 4.4.4 maximal
inequality.
...
`eLpNorm` wrapper also compile.  Aim at one forward textbook packet: package
Durrett Theorem 4.4.6 `L^p` convergence from Theorem 4.2.11 plus Theorem 4.4.4.
