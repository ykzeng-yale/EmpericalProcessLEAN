...
Route from `Live In-Thread Goal Prompt V76` in
...
The next target is the concrete cylinder square-root factorization and
square-integral estimates consumed by that bridge, the HasProd/prefix
