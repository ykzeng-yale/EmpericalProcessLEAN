...
- Manual goal policy: the app-level `/goal` objective text cannot be edited
  ...
  work.
- Current manual frontier after local sync to `origin/main` at `1061241`
  (`Add Chewi ellipsoid rank-one action support`) with the verified
  ...
  support and concrete displayed-to-normalized forward-shape transport packets
  in `StatInference/Optimization/Ellipsoid.lean`:
