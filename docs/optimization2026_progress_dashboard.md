...
- Manual goal policy: the app-level `/goal` objective text cannot be edited
  ...
  work.
- Current manual frontier after the 2026-05-05 standard-cut scalar containment
  and determinant-ratio packet, building on pushed frontier `489d182`
  ...
  rate layer plus normalized scalar central-cut containment and determinant-
  ratio cores compile in `StatInference/Optimization/Ellipsoid.lean`, while
  the exact
...
Latest proof target after the standard-cut scalar containment and
determinant-ratio packet: Chapter 6 nonsmooth convex optimization.  Theorems 6.14
...
normalized central-cut scalar containment and determinant-ratio cores.  The
...
`chewi620_standard_cut_scalar_containment` and
