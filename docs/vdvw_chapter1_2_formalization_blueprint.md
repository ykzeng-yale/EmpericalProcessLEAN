...
3. Promote Chapter 2 primitive infrastructure: covering/packing semimetric
   ...
   proof-carrying `VdVWTheorem243SymmetrizationPrecursor` package are now
   compiled.  The next frontier is a finite product-sample mean-zero bridge if
   needed by the final assembly, then full theorem-specific product/Fubini
