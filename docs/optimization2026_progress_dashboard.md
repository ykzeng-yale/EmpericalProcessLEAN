...
- Manual goal policy: the app-level `/goal` objective text cannot be edited
  ...
  work.
- Current manual frontier after focused Lean verification and targeted module
  build of the Chapter 11.4 source-recurrence alternating-minimization bridge
  on 2026-05-06, building on pushed frontier `29b2a60` (`Add Chewi theorem
  11.4 scalar AM packet`): Chapter 9/10 now has a compiled finite-valued
  ...
  source recurrence/half-threshold bridge, and source `K/M`/epsilon wrappers.
  The active lane is now the algorithm-facing AM trajectory/certificate bridge
  for exact Theorem 11.4, then Theorem 11.5 RAM, Sinkhorn 11.7/11.8 from
  ABP/mirror-descent wrappers, and Chapter 12 SMPGD.
