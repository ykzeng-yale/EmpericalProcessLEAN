...
1. Move one layer closer to a model-facing finite-dimensional statement:
   continue from the coordinate score-measurability fixed-`theta0` endpoint toward a concrete
...
Latest verified Vaart frontier before the next packet: the coordinate
score-measurability source endpoint for Vaart Theorem 5.41.
...
full-domain smoothness endpoint to a concrete model-specialized Theorem 5.41
instantiation, or instantiate one remaining root/envelope field.
