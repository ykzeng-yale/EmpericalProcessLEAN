...
- Current manual frontier after focused Lean verification of the Chapter 11.4
  block-descent certificate bridge on 2026-05-06, building on pushed frontier
  `d776c6a` (`Add Chewi theorem 11.4 burn-in scalar layer`): Chapter 9/10 now has a compiled finite-valued
  ...
  inequalities into the displayed source recurrence.  The active lane is now
  instantiating the descent certificate from actual coordinate/proximal
  minimization if bounded, plus an exact log/ceil threshold wrapper; then
