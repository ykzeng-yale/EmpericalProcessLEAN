...
3. Promote Chapter 2 primitive infrastructure: covering/packing semimetric
   ...
   needed value-set boundedness.  The next frontier is proving the integrated
   product-sample `hphi_id` by sign-symmetry and measurable-cover
   outer-expectation assembly, then entropy-to-convergence and final assembly.
