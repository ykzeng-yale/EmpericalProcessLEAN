...
The current blocker plan contains `Live In-Thread Goal Prompt V597`, the live
`/goal` replacement prompt.  Use it when the app-level objective is older than
the verified route docs; do not create a duplicate goal or recurring
automation.

Current immediate target after V597: stay on Durrett Theorem 2.4.9
...
final-display source wrapper not already covered by V500-V597,
...
expectation-exists-and-value wrappers for finite/range/Ico and one-based
range/Ico/`Icc` composed products,
the V535 source-side iid/common-transform composed Chapter 2.1.13
expectation-exists-and-power-value wrappers for finite/range/Ico and one-based
range/Ico/`Icc` products,
the V536 source-side iid/common-transform composed Chapter 2.1.13 zero-factor
expectation-exists wrappers for finite/range/Ico and one-based range/Ico/`Icc`
products,
the V537 source-side iid/indexed-transform composed Chapter 2.1.13
expectation-exists-and-value wrappers for finite/range/Ico and one-based
range/Ico/`Icc` products,
the V538 source-side iid/indexed-transform composed Chapter 2.1.13 zero-factor
expectation-exists wrappers for finite/range/Ico and one-based range/Ico/`Icc`
products,
the V539 law-side iid/indexed-transform Chapter 2.1.13
expectation-exists-and-value wrappers for finite/range/Ico and one-based
range/Ico/`Icc` products,
the V540 law-side iid/indexed-transform Chapter 2.1.13 zero-factor
expectation-exists wrappers for finite/range/Ico and one-based range/Ico/
`Icc` products,
...
`ENNReal.ofReal` product formulas for finite/range/Ico and one-based
range/Ico/`Icc` products,
the V543 law-side iid/indexed-transform Chapter 2.1.13 real nonnegative
`ENNReal.ofReal` zero-factor formulas for finite/range/Ico and one-based
range/Ico/`Icc` products,
the V544 law-side iid/indexed-transform Chapter 2.1.13 nonnegative `ℝ≥0∞`
zero-factor formulas for finite/range/Ico and one-based range/Ico/`Icc`
products,
the V545 source-side iid/indexed-transform Chapter 2.1.13 nonnegative
...
`ENNReal.ofReal` product formulas for finite/range/Ico and one-based
range/Ico/`Icc` products,
the V548 source-side iid/indexed-transform Chapter 2.1.13 real nonnegative
`ENNReal.ofReal` zero-factor formulas for finite/range/Ico and one-based
range/Ico/`Icc` products,
the V549 source-side composed-function Chapter 2.1.13 nonnegative `ℝ≥0∞`
...
product formulas for finite/range/Ico and one-based range/Ico/`Icc` composed
products,
the V554 source-side composed-function Chapter 2.1.13 absolute-value/norm
zero-factor formulas for finite/range/Ico and one-based range/Ico/`Icc`
composed products,
the V555 source-side iid/indexed-transform Chapter 2.1.13 absolute-value/norm
product formulas for finite/range/Ico and one-based range/Ico/`Icc` products,
the V556 source-side iid/indexed-transform Chapter 2.1.13 absolute-value/norm
zero-factor formulas for finite/range/Ico and one-based range/Ico/`Icc`
products,
the V557 source-side iid/common-transform Chapter 2.1.13 absolute-value/norm
...
products,
the V560 source-side iid/common-transform Chapter 2.1.13 nonnegative
`ℝ≥0∞` zero-factor formulas for nonempty finite, positive range/Ico, and
one-based range/Ico/`Icc` products,
the V561 source-side iid/common-transform Chapter 2.1.13 real nonnegative
`ENNReal.ofReal` power formulas for finite/range/Ico and one-based
range/Ico/`Icc` products,
the V562 source-side iid/common-transform Chapter 2.1.13 real nonnegative
`ENNReal.ofReal` zero-factor formulas for nonempty finite, positive range/Ico,
and one-based range/Ico/`Icc` products,
the V563 law-side iid/common-law Chapter 2.1.13 nonnegative `ℝ≥0∞`
zero-factor formulas for nonempty finite, positive range/Ico, and one-based
range/Ico/`Icc` products,
the V564 law-side iid/common-law Chapter 2.1.13 real nonnegative
`ENNReal.ofReal` zero-factor formulas for nonempty finite, positive range/Ico,
and one-based range/Ico/`Icc` products,
...
the V567 law-side composed-function Chapter 2.1.13 absolute-value/norm product
