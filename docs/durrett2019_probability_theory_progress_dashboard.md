...
Cramér-Wold/finite-coordinate CLT machinery.  The compiled declaration
...
28. Durrett Theorem 3.10.6 now has the finite-coordinate law-level Cramér-Wold
    ...
    Vaart finite-coordinate Cramér-Wold theorem.  Next target:
    Theorem 3.10.7 multivariate CLT packaging from projected scalar CLTs.
...
Next proof packet: Durrett Theorem 3.10.7 finite-coordinate multivariate CLT
from projected scalar CLTs, reusing
`durrett2019_theorem_3_10_6_cramerWold_finiteCoordinate_lawTendsto` and local
Vaart Cramér-Wold bridge machinery.
