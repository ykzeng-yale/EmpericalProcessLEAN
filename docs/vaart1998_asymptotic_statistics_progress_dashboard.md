...
Latest verified packet: observation-score vector mean source
...
Immediate predecessor packet: Gaussian-limit coordinate-measurability source
endpoint for the score-at-theta0/Taylor route, including
...
Current next blocker: continue from the observation-score vector mean
