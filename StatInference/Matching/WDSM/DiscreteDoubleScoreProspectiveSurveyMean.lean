...
/-!
# Finite double-score prospective survey-weighted mean recovery

This module combines joint double-score projection algebra with the
prospective/common-sampling survey-weighted mean recovery layer.  It proves
finite PATE and PATT wrappers where a single inverse common selected-data
weight recovers target score-measurable contrasts on joint double-score cells.
-/
...
/--
Finite prospective double-score PATE recovery under common cell-level sampling.
-/
theorem weightedSampleMeanContrast_eq_prospectivePATEDoubleScoreWeight
...
/--
Finite prospective double-score PATT recovery under common cell-level sampling.
-/
theorem weightedSampleMeanContrast_eq_prospectivePATTDoubleScoreWeight
    (targetSample selectedSample : Finset Unit)
