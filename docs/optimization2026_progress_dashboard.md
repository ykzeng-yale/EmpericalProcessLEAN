...
- Current manual frontier after the Chapter 12 finite sampled rate packet and
  focused Lean verification of the Chewi Theorem 12.1 SMPGD smooth and
...
sampled rate packet: treat Chapters 3-8, Chapter 9/10
...
smooth/pointwise-bounded non-smooth sampled endpoints.  Prove variance
domination from (12.1), Bochner expectation transport for sampled oracles, and
the non-smooth upgrade from pointwise bounded sampled gradients to the source
L2 assumption (12.2), then instantiate the compiled smooth L2-noise and
non-smooth integral-component final rate wrappers.
