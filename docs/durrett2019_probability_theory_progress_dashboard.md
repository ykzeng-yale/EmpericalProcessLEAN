...
Route from `Live In-Thread Goal Prompt V240` in
...
probability bound.  The next target is the layer-cake/Fubini split; do not
redo the Doob/Kolmogorov probability conversion, stopped-source packaging, or
raw/stopped survival packaging.
...
Next proof packet: package the layer-cake/Fubini split from the compiled V240
finite-horizon probability bound for
...
packaging, or the V240 raw/stopped survival split while this frontier is
active.
