...
3. Promote Chapter 2 primitive infrastructure: covering/packing semimetric
   ...
   finite-net expected-maximal bound are now compiled.  The next frontier is
   proving the product outer-expectation projection for the expectation-level
   route, then entropy-to-convergence and final assembly.
