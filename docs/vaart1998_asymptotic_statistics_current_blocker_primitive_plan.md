...
and mean-zero sources, assumes the all-dual covariance-bilinear comparison
...
via `vaart1998_zLaw_map_mean_zero_of_sample_mean_zero`. It rebuilds
...
sources unless a source theorem specifically demands those displays.
