...
`PLGradientFlowLyapunovSideConditionRouteToQGOn` hypothesis by proving or
cleanly supplying the gradient-flow convergence-to-minimizer input,
positive-gap side condition, and nonzero displacement on positive times; the
derivative-to-antitone, PL scalar sign, objective-gap derivative, nonzero
norm-derivative, trajectory/gap continuity, and Lyapunov-continuity
