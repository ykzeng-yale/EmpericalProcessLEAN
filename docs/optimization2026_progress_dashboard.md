...
- Current manual frontier after local sync to `origin/main` at `5f759ac`
  ...
  `chewi620_displayedMatrices_stepCertificate_of_cfcSqrt_posDef`.  The next
  target is the displayed next-shape PosDef theorem for Lemma 6.20, while the
