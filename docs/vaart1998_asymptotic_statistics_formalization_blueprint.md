...
Current frontier: Theorem 5.41 now has a compiled coordinate score-measurability source
endpoint
...
It replaces vector-valued score-transform measurability by coordinatewise
score measurability. Its immediate predecessor is the observation-sequence
evaluation source endpoint
...
`measurable_pi_lambda`. The next proof packet should continue from this
endpoint to a concrete model-specialized
