...
Route from `Live In-Thread Goal Prompt V25` in
...
exponential moment.  The next frontier is the source-facing strict-index
Theorem 4.2.4 and Theorem 4.2.5 all-times conditional expectation
consequences, then Theorem 4.2.6 if immediate.
...
4.2.3 product and normalized exponential martingale wrappers.
...
Next proof packet: package Theorem 4.2.4 and Theorem 4.2.5 as source-facing
strict-index consequences for supermartingales, submartingales, and martingales,
reusing the compiled all-times conditional-expectation wrappers in
`StatInference/ProbabilityTheory/Martingale.lean`.  If those are immediate,
continue directly to Theorem 4.2.6 convex-image submartingales.
