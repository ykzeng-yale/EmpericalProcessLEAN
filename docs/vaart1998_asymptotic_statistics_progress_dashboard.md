...
Latest verified packet: unscaled score source endpoint for the
...
the unscaled textbook score identity.

Immediate predecessor packet: fixed true-parameter source endpoint for the
score-at-theta0/Taylor route, including
...
Current next blocker: continue from the unscaled score fixed-`theta0` Theorem
5.41 endpoint toward a concrete model-specialized instantiation, or package
