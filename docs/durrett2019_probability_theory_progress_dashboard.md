...
Route from `Live In-Thread Goal Prompt V207` in
...
The next target is the conditional-variance/pull-out comparison plus the
deterministic integral comparison for `b_n = f(A_n)`, using V204-V207 as closed
support.
