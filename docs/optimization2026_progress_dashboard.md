...
- Manual goal policy: the app-level `/goal` objective text cannot be edited
  ...
  work.
- Current manual frontier after focused Lean verification of the Chapter 11.4
  log-burn-in rate layer on 2026-05-06, building on pushed frontier
  `613bf36` (`Add Chewi theorem 11.4 threshold tail layer`): Chapter 9/10 now has a compiled finite-valued
  ...
  The active lane is now only the cheap Nat.ceil/positive-part display wrapper
  if it is immediately available, plus instantiating the descent certificate
  from actual coordinate/proximal minimization if bounded; otherwise move to
  Theorem 11.5 RAM, Sinkhorn 11.7/11.8 from ABP/mirror-descent wrappers, and
  Chapter 12 SMPGD.
