...
Latest verified packet: law-side limit coordinate-mean source endpoint for the
...
Immediate predecessor packet: law-side score coordinate-mean source endpoint
