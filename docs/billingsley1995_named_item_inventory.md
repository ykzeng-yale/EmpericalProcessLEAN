...
| Sections 15-16 integration and limit theorems | `_122-242.md` near Section 16 start | local-wrapper | `StatInference/ProbabilityMeasure/Tail.lean` wraps mathlib layer-cake, tail-integral monotonicity, split-at-radius, and Markov APIs for VdV&W Theorem 2.4.3 tail and truncation support. This is a content-based support layer, not a source-exact Billingsley Sections 15-16 theorem report; exact item selection, source screenshots, and report remain pending. |
| Section 18 product measure/Fubini | `_243-363.md:61,67,73,111,115,119,173,185` | local-wrapper | `StatInference/ProbabilityMeasure/ProductMeasure.lean` wraps mathlib product probability measures, Tonelli/Fubini, product-coordinate marginal projection, and separated product-expectation identities for symmetrization. This is a content-based support layer, not a source-exact Billingsley Section 18 theorem report. |
