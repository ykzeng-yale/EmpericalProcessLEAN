...
The remaining blocker is product outer-expectation projection for this route,
followed by entropy-to-convergence.
...
NEXT       Product outer-expectation projection for expected random-cover finite-net route, then entropy-to-convergence.
