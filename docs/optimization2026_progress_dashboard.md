...
Next high-value task: Chewi Proposition 2.7 main-text implications, starting
with strong convexity implies PL under a minimizer/gradient-zero interface,
then the PL-to-quadratic-growth route used in the notes.  Continue with
Corollary 2.8 afterward.  Do not spend proof runs on exercise derivations
until the main theorem lane is covered.
