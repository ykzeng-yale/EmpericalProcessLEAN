...
3. Promote Chapter 2 primitive infrastructure: covering/packing semimetric
   ...
   upper measurability/integrability packaging, and measurable-cardinality
   finite-net mean and integrated-mean consumers are now compiled.
   The next frontier is supplying measurable cardinality plus boundedness/UI or
   dominated-convergence input from entropy and selecting a shrinking
   deterministic empirical-cover radius from the all-radius entropy hypothesis,
   then final assembly.
