...
Current frontier: Theorem 5.41 now has a compiled coordinate mean-zero source
...
It replaces vector-valued Gaussian and score-transform mean-zero fields by
coordinatewise mean-zero hypotheses, using
`vaart1998_vector_integral_zero_of_coordinate_mean_zero` to recover the
vector Bochner integral fields. Its immediate predecessor is the
centered-product covariance source endpoint
