...
- Current manual frontier after local sync to `origin/main` at `95ca18b`; the
  ...
  square-root adjoint/cut bridge packet after the 2026-05-05 standard-cut
  scalar, determinant-ratio, coordinate-free affine-containment,
  ...
  quadratic/positive-denominator and normalized-cut algebra bridge, and the
  symmetric square-root raw-adjoint/cut bridge compile in
...
certificate using mathlib
  ...
  adjoint/cut bridge is now complete; next close the matrix
  invertibility/cancellation, pullback, and determinant/volume pieces.  If the
