...
Latest verified packet: coordinate score-measurability source endpoint for the
...
Immediate predecessor packet: observation-sequence evaluation source endpoint for the
score-at-theta0/Taylor route, including
...
Current next blocker: continue from the coordinate score-measurability
