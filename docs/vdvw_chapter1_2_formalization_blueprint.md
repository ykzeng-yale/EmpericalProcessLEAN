...
| 1.2.3 | Lemma | `..._1-100.md:438` | local-layer: outer/inner event probability, arbitrary measurable set cover to event-indicator cover, event lower-indicator lower cover, inner-expectation indicator equality, and two-sided complement expectation identities |
