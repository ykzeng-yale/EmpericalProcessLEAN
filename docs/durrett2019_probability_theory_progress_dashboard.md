...
Route from `Live In-Thread Goal Prompt V61` in
...
pi-system generators made of finite unions of cells.  The next target is
Theorem 4.3.8 Kakutani dichotomy for infinite product measures.
