...
Move next to a model-specific proof of the Taylor zero display and negligible
residual, or use a genuinely model-specific derivative or score representation
...
strong-law/action-bound/law-tail/display-congruence/display-convergence/display-weak-convergence/score-equation-OP/Taylor-zero-OP
