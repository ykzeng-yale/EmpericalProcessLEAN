...
- Current manual frontier after focused Lean verification of the Chapter 11.5
  ...
  `IsChewi115RAMZeroGapCertificate.gap_le_eps`.  The active 11.5 lane is now
  the analytic conditional-expectation/Hopf-Lax bridge into those certificates,
  plus a zero-hit wrapper only if it is cheap.
