...
Latest verified packet: sampled derivative basis-column source endpoint for the
...
Immediate predecessor packet: finite-coordinate limit covariance source endpoint
