...
Latest verified packet: vector score-transform measurability and `L²` source
...
Immediate predecessor packet: vector score-transform `L²` source
endpoint for the score-at-theta0/Taylor route, including
...
Current next blocker: continue from the vector score-transform measurability and `L²`
