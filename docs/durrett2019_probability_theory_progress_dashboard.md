...
Route from `Live In-Thread Goal Prompt V91` in
...
compile.  The next target is the actual tail-coordinate measurable tail-limit
candidate plus the canonical prefix/tail cylinder-likelihood factorization
needed for the remaining Kakutani criterion assembly.
