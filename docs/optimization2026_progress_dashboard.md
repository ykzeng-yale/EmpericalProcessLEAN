...
- Manual goal policy: the app-level `/goal` objective text cannot be edited
  ...
  work.
- Current manual frontier after focused Lean verification and root
  ...
  verified Optimization proof frontier is `2c62fec` (`Add Chewi theorem 10.13
  OMD regret packet`).  `MirrorDescent.lean` compiles
  ...
  corollary in the ordinary Hilbert norm.  Next aggressive theorem lane:
  Chapter 11 alternating Bregman projections/minimization, beginning with a
  Bregman projection certificate and Lemma 11.2 finite telescoping packet.
