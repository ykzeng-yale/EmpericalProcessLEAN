...
Route from `Live In-Thread Goal Prompt V88` in
...
zero-set-null and the positive-branch conclusion also now compiles.  The next
target is the concrete zero-set tail-measurability endpoint and remaining
