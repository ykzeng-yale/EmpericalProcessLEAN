...
Route from `Live In-Thread Goal Prompt V59` in
...
identity for Theorem 4.3.5 now compiles.  The next target is Example 4.3.7
finite partition likelihood-ratio approximation, then Theorem 4.3.8 Kakutani
