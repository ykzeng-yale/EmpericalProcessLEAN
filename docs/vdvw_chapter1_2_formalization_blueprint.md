...
| 1.2.5 | Lemma | `..._1-100.md:467` | local-layer: measurable-target first/second coordinate product-cover transfers compiled as `VdVWMeasurableCover.fstProductOfMeasurable` and `.sndProductOfMeasurable`, using mathlib product-a.e. section/Fubini APIs; full arbitrary-map perfect-projection theorem still pending |
