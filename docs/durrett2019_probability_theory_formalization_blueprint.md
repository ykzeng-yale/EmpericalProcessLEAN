...
The current blocker plan contains `Live In-Thread Goal Prompt V374`, the live
...
`StatInference/EmpiricalProcess/RealHalfLineGC.lean`.  V374 adds closed-endpoint
