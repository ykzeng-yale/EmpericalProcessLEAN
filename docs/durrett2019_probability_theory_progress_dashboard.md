...
Route from `Live In-Thread Goal Prompt V132` in
`docs/durrett2019_probability_theory_current_blocker_primitive_plan.md`.
The active theorem lane is Chapter 4.4 martingale maximal inequalities.  The
current frontier is Example 4.4.9 shifted geometric-sum boundedness and `L^2`
convergence support after the compiled finite-sum second-moment display layer.
...
The next target is Example 4.4.9 shifted geometric-sum boundedness and `L^2`
convergence support.
...
recurrence, and finite-sum display layers now compile.  Aim at one forward
textbook packet: Example 4.4.9 shifted geometric-sum boundedness and `L^2`
convergence support.
