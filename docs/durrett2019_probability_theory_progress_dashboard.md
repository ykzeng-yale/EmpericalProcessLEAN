...
Route from `Live In-Thread Goal Prompt V519` in
...
`ENNReal.ofReal` wrappers, and iid law-side range/Ico power displays.  The
...
plumbing or the closed V500-V519 2.4.9/2.1 source-wrapper surfaces unless an
