...
## Live In-Thread Goal Prompt V557
...
Latest verified target V557 adds source-side iid/common-transform Chapter
...
Use `Live In-Thread Goal Prompt V557` at the top of this file.  Historical route
