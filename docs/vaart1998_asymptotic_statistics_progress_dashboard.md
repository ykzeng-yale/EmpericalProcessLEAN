...
Latest verified packet: scaled-estimator display source endpoint for the
...
Immediate predecessor packet: textbook sqrt-scale source endpoint for the
score-at-theta0/Taylor route, including
...
`estimatingAtEstimator` to their textbook definitions.
...
Do not replay scaled-estimator display wrappers.
