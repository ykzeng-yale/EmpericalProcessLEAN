...
Latest verified packet: derivative-transform law-mean source endpoint for the
...
Immediate predecessor packet: derivative-transform law-integrability source endpoint
