...
Latest verified packet: observation-level score covariance source endpoint for
...
Immediate predecessor packet: observation-level score-transform coordinate
