...
- Current manual frontier: Chapter 5 CG is past the basic Krylov/termination
  ...
  The active target is discharging/packaging Lyapunov continuity, then the
  exact source-facing Theorem 5.8 statement and Theorem 5.9.
