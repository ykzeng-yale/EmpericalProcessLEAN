...
the score transform; full vector-valued measurability for the derivative
transform; vector-valued observation integrability plus a single vector-valued
...
finite-dimensional measurability of `Z` via
`measurable_pi_lambda`; do not replace this with
...
derivative-measurability, or derivative-integrability sources, abstract
score-law moment assumptions, abstract score-law covariance-bilinear
