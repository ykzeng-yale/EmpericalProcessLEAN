...
- Current manual frontier after the Chapter 12 sampled-model bridge packet and
  focused Lean verification of the Chewi Theorem 12.1 SMPGD finite
...
sampled-model bridge packet: treat Chapters 3-8, Chapter 9/10
...
Next theorem-sized packet: finish the remaining sampled stochastic model
fields above the Bochner transport, smooth L2-noise wrappers, and finite
raw/growth/star-upper bridge.  Prove variance domination from (12.1),
...
bounded-gradient estimates from (12.2).  Then instantiate the compiled smooth
L2-noise and non-smooth integral-component final rate wrappers.
...
component-hcore, finite-support, Bochner-integral, smooth L2/Hölder noise, and
finite sampled-model bridge packets reuse local Gronwall/geometric weight
infrastructure and leave only the remaining concrete sampled probability/model
estimates as the active formal blocker.
