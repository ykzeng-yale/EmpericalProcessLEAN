...
Current frontier: Theorem 5.41 now has a compiled observation-sequence evaluation source
endpoint
...
sampling directly from the measurable infinite observation sequence. Its
immediate predecessor is the joint-measurability source endpoint
...
from the current route. The next proof packet should continue from this
