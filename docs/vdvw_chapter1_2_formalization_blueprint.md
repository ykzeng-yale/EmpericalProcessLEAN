...
3. Promote Chapter 2 primitive infrastructure: covering/packing semimetric
   ...
   supplied-`hphi_id` finite-net projection are now compiled.
   ...
   needed value-set boundedness.  The next frontier is proving `hphi_id` by
