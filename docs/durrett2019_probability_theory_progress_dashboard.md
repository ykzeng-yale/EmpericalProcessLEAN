...
Route from `Live In-Thread Goal Prompt V137` in
`docs/durrett2019_probability_theory_current_blocker_primitive_plan.md`.
The active theorem lane is Chapter 4.4 martingale maximal inequalities.  The
current frontier is the actual Exercise 4.4.6 exit/hitting stopping-time and
variance-clock instantiation feeding the compiled stopped-variance handoff.
...
Theorem 4.4.1 optional-stopping wrappers and Exercise 4.4.6's stopped-variance
small-ball handoff now also compile.  The next target is the actual Exercise
4.4.6 exit/hitting stopping-time and variance-clock instantiation.
...
wrappers and Exercise 4.4.6's stopped-variance small-ball handoff now compile.
Aim at one forward textbook packet: instantiate Exercise 4.4.6's exit/hitting
stopping time and variance clock, or move to a nearby Chapter 4.4 theorem-sized
packet if that route is blocked.
