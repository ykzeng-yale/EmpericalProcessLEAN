...
| 1.2.2 Lemma | `M1:389` | a.s. rules for arbitrary maps | local layer exists: nonnegative sup/add/inf/product, threshold-indicator, and measurable-left inf-equality cover algebra; exact extended-real signed clauses, subtraction, absolute value, and remaining equality cases remain pending |
