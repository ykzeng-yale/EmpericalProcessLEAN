...
Route from `Live In-Thread Goal Prompt V21` in
...
Next proof packet: move directly to Example 4.2.2 quadratic martingale and add
only the narrow source-calculation bridge needed there.
