...
Use one report folder per proved theorem or theorem layer.
...
State whether the Lean theorem is exactly the textbook theorem or a proved
layer needed by the theorem.  If it is a layer, list remaining primitive
