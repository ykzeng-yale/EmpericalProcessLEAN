...
Move next to a model-specific proof of the linear score equation and negligible
...
strong-law/action-bound/law-tail/display-congruence/display-convergence/display-weak-convergence/score-equation-OP
