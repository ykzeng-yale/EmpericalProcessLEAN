...
Route from `Live In-Thread Goal Prompt V201` in
...
for Theorem 4.5.2.  The next target is the remaining source instantiation:
derive stopped-predictability and stopped running-maximum boundedness from the
