...
This endpoint is the preferred current route. It uses full vector-valued
measurability for the score and derivative transforms, vector-valued
observation integrability plus a single vector-valued observation derivative
mean for the derivative transform, observation-level score-transform `L²` and
mean-zero sources, coordinatewise measurability for the Gaussian limit
representative `Z`, and assumes only the textbook centered-product covariance
display: a table `Gamma`, sample-level products
...
direct observation-level covariance equality, pushed-forward derivative-law
vector-mean, coordinatewise observation basis-action, or coordinatewise
score-measurability, derivative-measurability, or derivative-integrability
sources, abstract score-law moment assumptions, abstract score-law
covariance-bilinear assumptions, pushed-forward score-transform all-dual
covariance-bilinear assumptions, pushed-forward score-transform coordinate
covariance assumptions, or full `Z` measurability, unless a source theorem
