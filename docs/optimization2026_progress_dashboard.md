...
- Manual goal policy: the app-level `/goal` objective text cannot be edited
  ...
  work.
- Current manual frontier after pushed Optimization commit `bba710e` (`Open
  Chewi stochastic gradient lane`) on 2026-05-06 and focused Lean/module
  verification of the Chewi Theorem 12.1 source recurrence and
  ...
  the smooth/non-smooth stochastic error floors directly.
...
Chapter 12 source recurrence and smooth/non-smooth scalar rate wrappers: treat Chapters 3-8, Chapter 9/10
...
Next theorem-sized packet: prove the stochastic/proximal one-step recurrence
interface that feeds the compiled smooth/non-smooth wrappers.  Keep the
concrete finite Sinkhorn KL identity layer as the next Chapter 11.8 blocker,
but do not let it stall Chapter 12 coverage.
...
SMPGD theorem existed; the new scalar/source-rate packet reuses local
Gronwall/geometric-weight infrastructure and leaves the expectation/proximal
one-step proof as the active formal blocker.
