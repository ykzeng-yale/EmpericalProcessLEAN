...
`chewi45_not_near_min_of_geometricRatio_tail_lower_bound`.
...
Next high-value task: prove the direct Exercise 4.2 geometric minimizer/tail
lower bound for `strongLowerBoundChainObjective`, then convert that geometric
obstruction into the logarithmic iteration-count statement.  In parallel,
