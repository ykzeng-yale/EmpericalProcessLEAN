...
Current frontier: Theorem 5.41 now has a compiled covariance-bilinear source
endpoint for the centered-product covariance route
...
vector-valued score-transform sources. Its immediate predecessor is the
