...
1. Move one layer closer to a model-facing finite-dimensional statement:
   continue from the Gaussian-limit/score-law coordinate covariance fixed-`theta0` endpoint toward a concrete
...
Latest verified Vaart frontier before the next packet: the Gaussian-limit/
score-law coordinate covariance source endpoint for Vaart Theorem 5.41.
...
Gaussian-limit/score-law coordinate covariance endpoint to a concrete
