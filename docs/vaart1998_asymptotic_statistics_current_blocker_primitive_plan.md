...
1. Move one layer closer to a model-facing finite-dimensional statement:
   connect the observation derivative basis-action endpoint to a concrete
...
The latest theorem-sized packet derives the sample-space population `V`
basis-action integral from the observation-level derivative-transform identity,
after specializing the score and derivative laws to observation pushforwards
and deriving pushforward score and derivative moment fields.
...
observation derivative basis-action endpoint to a concrete model-specialized
