...
- Current manual frontier after rebasing local `main` onto `origin/main` at
  `b21bcbd` (`Add asymptotic tightness reindexing`) with the verified
  ...
  The next target is Chapter 6 Theorems 6.21-6.25, while the exact
