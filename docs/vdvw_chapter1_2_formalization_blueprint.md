...
3. Promote Chapter 2 primitive infrastructure: covering/packing semimetric
   ...
   product-sample pair-difference weighted-sum mean-zero bridge are now
   compiled.  The next frontier is full theorem-specific product/Fubini
   symmetrization assembly, entropy-to-convergence, and final assembly.
