...
The remaining blocker is proving the finite-net Hoeffding upper mean tends to
zero from the entropy condition plus a variable-domain bounded-convergence or
uniform-integrability primitive, then final assembly.
