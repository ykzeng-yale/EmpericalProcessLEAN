...
Route from `Live In-Thread Goal Prompt V60` in
...
absolute-continuity condition.  The next target is the finite generated
sigma-field/refinement assembly for Example 4.3.7, then Theorem 4.3.8 Kakutani
dichotomy for infinite product measures.
