...
3. Promote Chapter 2 primitive infrastructure: covering/packing semimetric
   ...
   finite-net projection, and sample-cover product-a.e. finite-net bridge are
   now compiled, and the random empirical-cover cardinality witness handoff is
   available.  The next frontier is consuming those witnesses in the product
   random-sign assembly, proving the product-a.e. finite-center Hoeffding
   predicate for the chosen covers, then entropy-to-convergence and final
   assembly.
