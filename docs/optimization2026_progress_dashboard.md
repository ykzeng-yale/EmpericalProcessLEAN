...
- Manual goal policy: the app-level `/goal` objective text cannot be edited
  ...
  work.
- Current manual frontier after the 2026-05-05 Theorem 6.16 source packet:
  ...
  contradiction, and `chewi616_exists_functionalConstraintSuccess`.  The
  active target is now the cutting-plane/center-of-gravity packet around
  Lemma 6.18 and Theorem 6.19.
...
forms.  The next manual goal packet should attack Lemma 6.18/Theorem 6.19:
define a cutting-plane/center-of-gravity trajectory interface with a supplied
Grünbaum-style volume-shrink hypothesis, prove the finite shrink recurrence,
and assemble the source rate wrapper for
`f (x (N - 1)) - fStar <= D * L * lambda^(N/d)` before moving to ellipsoid
Lemma 6.20.
