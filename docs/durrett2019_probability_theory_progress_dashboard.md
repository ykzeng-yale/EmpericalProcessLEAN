...
Route from `Live In-Thread Goal Prompt V129` in
...
The next target is Theorem 4.4.8 conditional variance formula.
...
endpoint now compile.  Aim at one forward textbook packet: Theorem 4.4.7
orthogonality of square-integrable martingale increments now compiles.  Aim at
one forward textbook packet: Theorem 4.4.8 conditional variance formula.
