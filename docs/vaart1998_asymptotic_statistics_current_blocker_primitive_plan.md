...
1. Move one layer closer to a model-facing finite-dimensional statement:
   connect the observation-level transform moment endpoint to a concrete
...
The latest theorem-sized packet derives pushforward score `L²`, score
coordinate mean-zero, and derivative coordinate integrability from
observation-level transform moment assumptions, after specializing the score
and derivative laws to observation pushforwards.
...
observation-level transform moment endpoint to a concrete model-specialized
