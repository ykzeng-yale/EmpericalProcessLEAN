...
Route from `Live In-Thread Goal Prompt V94` in
...
under pointwise finite and nonzero coordinate densities.  The next target is
proving or packaging source convergence of the standard full-prefix
likelihoods for the remaining Kakutani criterion assembly.
...
| Chapter 4 martingales | active/source-wrapper | `StatInference/ProbabilityTheory/Basic.lean`; `StatInference/ProbabilityTheory/ConditionalExpectation.lean`; `StatInference/ProbabilityTheory/Martingale.lean`; mathlib `Probability/ConditionalExpectation.lean` and `Probability/Martingale/*` | Chapter 4.1 conditional expectation is compiled through Theorem 4.1.15. Chapter 4.2 now has martingale/submartingale/supermartingale adaptedness, integrability, conditional expectation identity/inequality, one-step, real constructor wrappers, Example 4.2.1 linear random-walk martingale/supermartingale/submartingale plus centered-display wrappers, Example 4.2.2 quadratic source and natural-random-walk wrappers, Example 4.2.3 product and normalized exponential martingale wrappers, Theorems 4.2.4/4.2.5 all-times and strict-index wrappers, Theorem 4.2.6 generic convex-image plus `|X_n|^p` wrappers, Theorem 4.2.7 increasing-convex plus positive-part/minimum consequences, Theorem 4.2.8 predictable-transform wrappers, Theorem 4.2.9 stopped-process wrappers, Theorem 4.2.10 upcrossing inequality wrappers, Theorem 4.2.11 direct L1/eLpNorm-bounded plus positive-part source convergence wrappers, Theorem 4.2.12 nonnegative-supermartingale convergence, integrable-limit, and Fatou expectation wrappers, Theorem 4.3.1 stopped-shifted, first-below, bounded-below, bounded-above, one-sided-bounded, range-form dichotomy, threshold-form oscillation, exact `EReal` liminf/limsup wrappers, Theorem 4.3.2 Doob-decomposition existence/formula and uniqueness wrappers, Example 4.3.3 plus Theorem 4.3.4 conditional Borel-Cantelli wrappers, the first Theorem 4.3.5 / Lemma 4.3.6 RN-derivative likelihood-ratio martingale and convergence wrappers, the Theorem 4.3.5 regular/singular decomposition identities, the density-ratio/top-set source assembly, the integral-representation to RN-derivative bridge, the generator-extension bridge, the bounded-convergence generator-production bridge, the trimmed-RN eventual restricted-density bridge, the `mu + nu` boundedness bridge, the real-to-`ENNReal` convergence-transfer endpoint, the bounded real-martingale limitProcess convergence bridge for the two natural `mu + nu` trimmed RN `toReal` sequences, the canonical finite nonnegative limit-density endpoint, the canonical-ratio endpoint, the denominator-side canonical-ratio top-null endpoint, the singular-support top-set endpoint, the full canonical-ratio real identity, the Example 4.3.7 finite-partition likelihood, finite-union, and generator-facing endpoint, the Theorem 4.3.8 finite-product likelihood measurability, rectangle set-integral, and finite-product `withDensity` endpoint, the infinite-product cylinder-likelihood measurability, finite-coordinate restriction `withDensity`, cylinder set-integral endpoint, finite/cylinder Hellinger factorization endpoints, zero-product Fatou/cylinder Hellinger-product endpoints, zero-product singularity handoffs from source real-identities and Hellinger/cylinder products, positive-product absolute-continuity handoffs from no-top-mass source real-identities, final zero/positive branch assemblers, the positive-branch eliminator, lintegral-nonzero/mass-one consumers, finite-cylinder mass-one/integral-convergence handoffs, positive-product L1-to-integral handoff, pairwise-liminf Cauchy-to-L1 handoff, Hellinger-tail-bound positive consumer, square-root/Cauchy-Schwarz Hellinger L1 bridge, normalized positive-prefix product-tail convergence bridge, concrete pointwise/cylinder square-root factorization plus concrete cylinder Cauchy handoff with the textbook factors, the `sqrt X_n + sqrt X_m` square-integral estimate, the scalar/cylinder Pythagorean overlap inequality, overlap-to-tail algebra handoff, concrete cylinder overlap handoff, lower-bound-only overlap Cauchy handoff for the `sqrt X_n - sqrt X_m` side, finite-coordinate product integral, exact nested square-root overlap factorization, finite Hellinger tail-product overlap handoff, HasProd/Multipliable prefix-tail bridge, standard `Finset.range n` HasProd-to-pairwise-liminf handoff, finite tail-product lower bound from positive prefix/tail monotonicity, standard positive-product range consumer, source-density one-coordinate Hellinger affinity `≤ 1` bound, normalized positive-product tail `≤ 1` bridge, standard source-density positive-product range consumer, standard `Finset.range n` source-density `HasProd` positive-product absolute-continuity handoff, a.e.-finite no-top source bridge, standard source-density `HasProd` absolute-continuity consumer using it, Kolmogorov tail-event zero-one support, zero-set-not-full positive-branch eliminator, lower-integral source bridge from tail zero set to zero-set-null and absolute continuity, every-tail-block measurability bridge into the `limsup` tail sigma-field with zero-set-null and absolute-continuity consumers, tail-coordinate sigma-field support for finite tail cylinder likelihoods plus zero-set-equality handoff, finite-prefix zero-set algebra with prefix-cylinder zero-set handoff, prefix/tail finite-block and tail-block-limit zero-set handoffs, pointwise finite/nonzero coordinate side-condition handoff, and range-limit tail handoff from full-prefix convergence to the canonical `X / prefix_n` tail-block limits. Next target: source convergence of the standard full-prefix likelihoods and final Kakutani criterion assembly. |
...
Next proof packet: continue Theorem 4.3.5 after the compiled likelihood-ratio
martingale/convergence bridge, regular/singular decomposition identity, and
density-ratio/top-set source assembly plus the compiled integral-representation
to RN-derivative bridge, generator-extension bridge, bounded-convergence
generator-production bridge, trimmed-RN eventual restricted-density bridge, and
`mu + nu` boundedness bridge.  Aim at one actual source-production obligation:
prove convergence of the trimmed RN derivative sequences, or prove `X = Y/Z` /
`{X = infinity}` singular separation.  Search nonnegative/bounded martingale
convergence wrappers, ENNReal-to-real bounded convergence transfers, RN
derivative addition/scaling APIs, a.e. transfer, ENNReal limsup/top, and
RN-derivative APIs.  Do not re-prove the compiled assembly layers.
