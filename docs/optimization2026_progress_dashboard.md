...
- Manual goal policy: the app-level `/goal` objective text cannot be edited
  ...
  work.
- Current manual frontier after pushed Optimization commit `1d21a6d` (`Add
  Chewi Sinkhorn mirror certificate`) on 2026-05-06 and focused Lean/module
  verification of the new Chapter 12 scalar SMPGD averaging spine:
  ...
  normalized SMPGD recurrence with an additive stochastic error.
...
new Chapter 12 scalar SMPGD averaging spine: treat Chapters 3-8, Chapter 9/10
...
interface and the smooth/non-smooth error instantiations needed by
`chewi121_weightedAverageGap_le_of_oneStep`.  Keep the concrete finite
Sinkhorn KL identity layer as the next Chapter 11.8 blocker, but do not let it
stall Chapter 12 coverage.
...
SMPGD theorem existed; the new scalar packet reuses local Gronwall/geometric
weight infrastructure and leaves the expectation/proximal one-step proof as
the active formal blocker.
