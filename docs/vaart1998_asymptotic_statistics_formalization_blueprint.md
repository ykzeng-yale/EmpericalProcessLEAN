...
It replaces vector-valued derivative-transform measurability by coordinatewise
derivative-table entry measurability. Its immediate predecessor is the
coordinate score-measurability source endpoint
...
the canonical finite Pi/Borel structure. The next proof packet should continue
