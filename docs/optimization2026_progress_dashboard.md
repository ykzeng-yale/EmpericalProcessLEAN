...
- Manual goal policy: the app-level `/goal` objective text cannot be edited
  ...
  work.
- Current manual frontier after focused Lean verification, promoted module
  ...
  `4656409` in `StatInference/Optimization/AlternatingBregman.lean`: Chapter
  9/10 now has a
  ...
  form.  Next aggressive theorem lane: either Corollary 11.3 convergence under
  supplied technical assumptions if bounded, or §11.2 alternating minimization
  block-coordinate descent interfaces.
