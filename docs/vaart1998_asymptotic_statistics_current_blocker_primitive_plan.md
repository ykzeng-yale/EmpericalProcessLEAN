...
and `measurable_pi_apply`. It still asks for coordinatewise integrability and
the `V` basis-action mean identity for this displayed derivative transform.
...
the score transform; coordinatewise observation integrability plus coordinatewise
observation derivative-at-theta0 basis-action means for the displayed derivative
transform; coordinatewise
...
integrability, separate `derivativeTransform` maps, pointwise
