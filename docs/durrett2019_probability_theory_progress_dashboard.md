...
2. use the compiled one-cell, two-cell, and right-append middle CDF partition
   constructors to prove the arbitrary-distribution finite middle partition
   constructor consumed by the compiled middle-partition-to-GC handoff;
...
- advance Durrett Theorem 2.4.9 by proving the arbitrary-distribution finite
  middle CDF partition existence theorem beyond the compiled
  one-cell/two-cell/right-append constructors consumed by the compiled GC
  handoff; or
