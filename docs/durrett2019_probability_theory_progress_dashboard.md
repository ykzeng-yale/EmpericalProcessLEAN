...
Route from `Live In-Thread Goal Prompt V77` in
...
cylinder Cauchy handoff with the textbook factors also now compile.  The next
target is the square-integral estimates for those fixed factors, the
