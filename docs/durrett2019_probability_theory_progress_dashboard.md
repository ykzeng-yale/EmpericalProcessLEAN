...
Route from `Live In-Thread Goal Prompt V116` in
...
The next target is the actual Durrett positive-part p-th-power estimate for
submartingales from Doob 4.4.2 plus integration/Hölder, feeding the compiled
...
endpoint.  Aim at one forward textbook packet: prove/package the actual
positive-part p-th-power estimate from Doob 4.4.2 and integration/Hölder.
