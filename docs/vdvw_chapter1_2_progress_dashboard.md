...
| Lemma 1.2.3 | Nonnegative event indicator bridges for outer/inner probability, explicit measurable event-cover existence, arbitrary measurable set covers, two-sided complement-expectation identities, and finite-measure event covers | Remaining extended-real and full measurable-set-cover clauses. |
