...
- Current manual frontier after the 2026-05-05 standard-cut scalar,
  ...
  quadratic/positive-denominator bridge compile in
...
and positive-denominator helpers for `Matrix.toEuclideanLin`.  The next manual
goal packet should instantiate the cut-normalization and displayed matrix
update hypotheses of that certificate using mathlib
