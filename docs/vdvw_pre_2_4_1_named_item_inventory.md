...
| 2.2.3 Definition | `M2:292-300` | covering/packing numbers for semimetric spaces | local-layer: semimetric covering/packing wrappers, comparison inequalities, total-boundedness-to-finiteness direction, raw separated-packing and proof-carrying empirical packing witnesses, empirical-wrapper packing/covering-number lower-bound handoffs for selected-cover lower bounds including terminal-sample source variants, and final set-countable Theorem 2.4.3 consumers for terminal raw packings, terminal finite-packing witnesses, empirical-wrapper packing/covering-number lower bounds, and infinite-covering lower growth; entropy/logarithm and open-ball exactness pending |
