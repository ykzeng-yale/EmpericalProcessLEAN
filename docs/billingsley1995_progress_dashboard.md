...
- Lean namespace started: `StatInference.Billingsley`.
- First modules: `StatInference/Billingsley/WeakConvergence.lean` and
...
| --- | --- | --- | --- |
| Section 25 weak convergence and tightness | local-wrapper | `StatInference/Billingsley/WeakConvergence.lean` | Reuses mathlib and local VdV&W wrappers for probability-measure weak convergence, tightness, Portmanteau, Levy-Prokhorov, continuous mapping, products, FDD restriction, and Slutsky. |
...
| Section 18 product/Fubini | priority-local | pending | Needed for symmetrization and iid independent-copy arguments. |
...
| Sections 36-38 process laws/cylinders/separability | local-wrapper | `StatInference/Billingsley/FiniteDimensional.lean` | Started finite-dimensional law wrappers over mathlib; defer broad path-space theory until needed. |
...
1. Add a Billingsley/integration-tail wrapper module or add directly to the
