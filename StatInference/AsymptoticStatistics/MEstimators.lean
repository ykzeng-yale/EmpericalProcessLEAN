...
Once the Taylor equation has the source form
`V x_n = -(score_n + residual_n)`, the existing score-equation handoff gives
weak convergence of `x_n`; Chapter 2 then supplies stochastic boundedness.
-/
theorem vaart1998_theorem_5_41_scaledEstimator_stochasticBounded_of_scoreEquation
    {Ω Ω' Score Θ : Type*}
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [NormedAddCommGroup Score] [NormedSpace ℝ Score]
...
/--
van der Vaart 1998, Theorem 5.41, empirical-average source handoff from
pointwise Taylor identities and an envelope bound, with non-circular
scaled-estimator tightness.

This is the empirical-average version of the absorbing quadratic Taylor
endpoint.  The source hypotheses no longer include an external
`scaledEstimator = O_P(1)` field; tightness is derived internally from the
score CLT, derivative LLN, consistency, the envelope-bounded second derivative,
and the root/Taylor display.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_pointwiseTaylor_envelope_absorbing
    {Ω Ω' Observation Score Θ : Type*}
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [NormedAddCommGroup Score] [NormedSpace ℝ Score]
  ...
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_root_quadraticTaylorExpansion_measurableDerivativeLLN_absorbing
      ...
      (estimatingEquationAtEstimator := fun n ω =>
        empiricalAverageVector (samples n ω) (estimatingAtEstimator n ω))
      (Z := Z) hLeftInverse hScoreCLT hDerivativeLLN hDelta
      hCurvatureBounded hCurvatureOpBound hEmpiricalDerivative_meas
...
/--
van der Vaart 1998, Theorem 5.41, empirical-average source handoff from raw
per-observation Taylor identities, with non-circular scaled-estimator
tightness.

This wrapper accepts the unscaled single-observation Taylor theorem and the
common normalizing scalar, then feeds the resulting pointwise scaled Taylor
identity into the absorbing empirical-average endpoint.  The external
`scaledEstimator = O_P(1)` hypothesis is no longer part of the source
interface.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_unscaledPointwiseTaylor_envelope_absorbing
    {Ω Ω' Observation Score Θ : Type*}
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [NormedAddCommGroup Score] [NormedSpace ℝ Score]
...
/--
van der Vaart 1998, Theorem 5.41, finite-coordinate empirical-average source
handoff from coordinatewise raw Taylor identities, with non-circular
scaled-estimator tightness.

This wrapper specializes the absorbing raw per-observation Taylor endpoint to
`Coord -> ℝ` score vectors.  The external `scaledEstimator = O_P(1)` hypothesis
is removed from the finite-coordinate raw Taylor source layer.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_coordinateRawTaylor_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
...
/--
van der Vaart 1998, Theorem 5.41, finite-coordinate empirical-average source
handoff from scalar path Taylor hypotheses, with non-circular scaled-estimator
tightness.

This wrapper first turns scalar path Taylor hypotheses plus the endpoint
second-derivative action identification into coordinate raw Taylor identities,
then feeds those identities into the absorbing coordinate raw Taylor endpoint.
The external `scaledEstimator = O_P(1)` hypothesis is no longer part of this
source layer.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_coordinatePathTaylor_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
  ...
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_coordinateRawTaylor_envelope_absorbing
      ...
      hCurvatureBounded hEnvelopeBound hEmpiricalDerivative_meas
      hSecondDerivativeAction_meas hDelta_meas hScaledEstimator_meas hRoot
      hScore_scaled hEstimator_scaled hScaledEstimator_eq hCoordinateRawTaylor
...
/--
van der Vaart 1998, Theorem 5.41, finite-coordinate empirical-average source
handoff from actual estimating-map coordinate paths, with non-circular
scaled-estimator tightness.

This is the actual estimating-map path version of the absorbing coordinate
path Taylor endpoint.  It instantiates the abstract path as
`t ↦ estimatingMap (theta0 + t • delta)` and derives the endpoint identities
from `theta0 + delta = estimator`, without assuming
`scaledEstimator = O_P(1)` externally.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapPathTaylor_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
  ...
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_coordinatePathTaylor_envelope_absorbing
      ...
      hCurvatureBounded hEnvelopeBound hEmpiricalDerivative_meas
      hSecondDerivativeAction_meas hDelta_meas hScaledEstimator_meas hRoot
      hScore_scaled hEstimator_scaled hScaledEstimator_eq hValue0 hValue1
      hDerivative0 hContinuous hDerivative hDerivativeTaylor hSecondAction
...
/--
van der Vaart 1998, Theorem 5.41, finite-coordinate empirical-average source
handoff from vector Taylor hypotheses for the Frechet derivative, with
non-circular scaled-estimator tightness.

This wrapper replaces the coordinate derivative-at-zero and scalar derivative
Taylor assumptions by source-shaped vector hypotheses, then applies the
absorbing Frechet-derivative path endpoint.  The external
`scaledEstimator = O_P(1)` hypothesis is no longer part of this vector Taylor
source layer.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapFDerivVectorTaylor_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
  ...
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapFDerivPathTaylor_envelope_absorbing
      ...
      hSecondDerivativeAction_meas hDelta_meas hScaledEstimator_meas hRoot
      hScore_scaled hEstimator_scaled hScaledEstimator_eq hEstimator_segment
      hDerivative0_coord hContinuous hFDeriv hDerivativeTaylor_coord
...
/--
van der Vaart 1998, Theorem 5.41, finite-coordinate empirical-average source
handoff from vector continuity and vector Taylor hypotheses, with non-circular
scaled-estimator tightness.

This wrapper replaces coordinate-path continuity by continuity of the full
finite-coordinate estimating-map path, then applies the absorbing Frechet
vector Taylor endpoint.  The external `scaledEstimator = O_P(1)` hypothesis is
no longer part of this vector-continuity Taylor source layer.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapFDerivVectorContinuityTaylor_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
  ...
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapFDerivVectorTaylor_envelope_absorbing
      ...
      hSecondDerivativeAction_meas hDelta_meas hScaledEstimator_meas hRoot
      hScore_scaled hEstimator_scaled hScaledEstimator_eq hEstimator_segment
      hDerivativeAt0 hContinuous_coord hFDeriv hDerivativeTaylor
...
This wrapper removes the explicit source hypothesis
`derivativeAt theta0 = derivative` by taking the empirical derivative itself
to be the Frechet derivative at `theta0`, then applies the absorbing
vector-continuity Taylor endpoint.  The external `scaledEstimator = O_P(1)`
hypothesis is no longer part of this theta0-specialized source layer.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapTheta0FDerivVectorTaylor_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
  ...
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapFDerivVectorContinuityTaylor_envelope_absorbing
      ...
      hSecondDerivativeAction_meas hDelta_meas hScaledEstimator_meas hRoot
      hScore_scaled hEstimator_scaled hScaledEstimator_eq hEstimator_segment
      hDerivativeAt0 hContinuous hFDeriv hDerivativeTaylor
...
This wrapper discharges the vector derivative Taylor identity by applying the
one-dimensional mean-value bridge to the vector path
`t ↦ derivativeAt (theta0 + t • delta) delta`, then feeds the absorbing
`theta0` Frechet endpoint.  The external `scaledEstimator = O_P(1)` hypothesis
is no longer part of this second-derivative path source layer.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapTheta0SecondDerivativePath_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
  ...
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapTheta0FDerivVectorTaylor_envelope_absorbing
      ...
      hSecondDerivativeAction_meas hDelta_meas hScaledEstimator_meas hRoot
      hScore_scaled hEstimator_scaled hScaledEstimator_eq hEstimator_segment
      hContinuous hFDeriv hDerivativeTaylor
...
This wrapper derives the derivative-path continuity and path derivative
assumptions from source regularity of `theta ↦ derivativeAt theta`, then feeds
the absorbing second-derivative path endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapTheta0SecondDerivativeRegularity_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
  ...
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapTheta0SecondDerivativePath_envelope_absorbing
      ...
      hSecondDerivativeAction_meas hDelta_meas hScaledEstimator_meas hRoot
      hScore_scaled hEstimator_scaled hScaledEstimator_eq hEstimator_segment
      hContinuous hFDeriv hRegular.1 hRegular.2
...
/--
van der Vaart 1998, Theorem 5.41, finite-coordinate empirical-average source
handoff from open-set `C^1` smoothness of the derivative map, with
non-circular scaled-estimator tightness.

The `ContDiffOn` source regularity is converted to the derivative-path
regularity fields and then routed through the absorbing regularity endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapTheta0SecondDerivativeContDiff_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
  ...
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapTheta0SecondDerivativeRegularity_envelope_absorbing
      ...
      hSecondDerivativeAction_meas hDelta_meas hScaledEstimator_meas hRoot
      hScore_scaled hEstimator_scaled hScaledEstimator_eq hEstimator_segment
      hContinuous hFDeriv hSource.1 hSource.2
...
van der Vaart 1998, Theorem 5.41, finite-coordinate empirical-average source
handoff from open-set `C^1` smoothness of both the estimating map and the
derivative map, with non-circular scaled-estimator tightness.

This discharges the estimating-map path-continuity and Frechet-derivative
fields before applying the absorbing derivative-map `ContDiffOn` endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapContDiffTheta0SecondDerivativeContDiff_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
  ...
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatingMapTheta0SecondDerivativeContDiff_envelope_absorbing
      ...
      hSecondDerivativeAction_meas hDelta_meas hScaledEstimator_meas hRoot
      hScore_scaled hEstimator_scaled hScaledEstimator_eq hEstimator_segment
      hEstimatingSource.1 hEstimatingSource.2 hOpen hSegmentSubset
...
/--
van der Vaart 1998, Theorem 5.41, finite-coordinate empirical-average source
handoff from an almost-sure empirical derivative law, with non-circular
scaled-estimator tightness.

This is the strong-law-to-probability bridge for the operator-valued empirical
derivative average, routed through the absorbing derivative-tendsto endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_derivativeAE_envelopeTendsto_summandMeasurable_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
...
/--
van der Vaart 1998, Theorem 5.41, score CLT handoff from the raw scaled
estimating map, with non-circular scaled-estimator tightness.

The textbook score is the normalized estimating map at `theta0`.  This bridge
uses the sampled scaling identity to transfer a CLT for that raw scaled
empirical average into the score-CLT field, then feeds the absorbing
derivative-a.e. endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_rawScoreCLT_derivativeAE_envelopeTendsto_summandMeasurable_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
...
/--
van der Vaart 1998, Theorem 5.41, root handoff from the raw estimating
equation, with non-circular scaled-estimator tightness.

The source theorem usually states that the empirical estimating equation is
zero at the estimator before applying the common normalization.  This bridge
uses the sampled estimator-scaling identity to produce the scaled root field,
then feeds the absorbing raw-score endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_rawRoot_rawScoreCLT_derivativeAE_envelopeTendsto_summandMeasurable_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
...
/--
van der Vaart 1998, Theorem 5.41, estimator-increment source handoff, with
non-circular scaled-estimator tightness.

This wrapper replaces the independent `delta` consistency and endpoint segment
assumptions by the source-shaped identity `delta = estimator - theta0`, and it
replaces the scaled-estimator identity by the corresponding direct expression
in the estimator increment before feeding the absorbing raw-root endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatorSub_rawRoot_rawScoreCLT_derivativeAE_envelopeTendsto_summandMeasurable_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
...
This wrapper derives the a.e.-measurability of `delta` and `scaledEstimator`
from measurability of the estimator, the base point, and the normalization
scale, plus the source-shaped increment identities, then feeds the absorbing
estimator-substitution endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_estimatorSubMeas_rawRoot_rawScoreCLT_derivativeAE_envelopeTendsto_summandMeasurable_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
...
/--
van der Vaart 1998, Theorem 5.41, scaled-estimator display weak-convergence
source for `O_P(1)`.

If the displayed scaled estimator converges in distribution, then Chapter 2
tightness gives stochastic boundedness, and the selected a.e. representative
`scaledEstimator` inherits that bound.
-/
theorem vaart1998_theorem_5_41_scaledEstimator_stochasticBounded_of_display_tendstoInDistribution
    {Ω Ω' Θ : Type*} [MeasurableSpace Ω] [MeasurableSpace Ω']
    {P : Measure Ω} {Q : Measure Ω'} [IsProbabilityMeasure P]
    [IsProbabilityMeasure Q]
    [NormedAddCommGroup Θ] [NormedSpace ℝ Θ]
    [MeasurableSpace Θ] [OpensMeasurableSpace Θ] [BorelSpace Θ]
...
/--
van der Vaart 1998, Theorem 5.41, scaled-estimator tightness handoff from
law tails, with non-circular scaled-estimator tightness.

This keeps the source-facing law-tail field for compatibility with the
non-absorbing API layer.  The absorbing route no longer needs to convert it
into an external `scaledEstimator = O_P(1)` assumption; it feeds the absorbing
estimator-measurability endpoint directly.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_scaledEstimatorLawTail_estimatorSubMeas_rawRoot_rawScoreCLT_derivativeAE_envelopeTendsto_summandMeasurable_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
    ...
    (hEnvelopeAverage_tendsto :
      TendstoInMeasure P
        (fun n ω => empiricalAverage (samples n ω) envelope)
        atTop (fun _ : Ω => envelopeMean))
    (_hScaledEstimator_lawTail : ∀ ε : ℝ, 0 < ε ->
      ∃ M : ℝ, 0 < M ∧
        ∀ᶠ n in atTop,
          (P.map (scaledEstimator n)).real {x : Θ | M ≤ ‖x‖} < ε)
    (hEnvelopeBound : ∀ᶠ n in atTop, ∀ ω x,
...
/--
van der Vaart 1998, Theorem 5.41, derivative strong-law handoff from the
operator-norm residual, with non-circular scaled-estimator tightness.

This is the absorbing companion to the derivative-norm law-tail wrapper above:
the derivative norm residual is converted to operator convergence, and the
source-facing law-tail field is carried into the absorbing law-tail endpoint
without first building an external `scaledEstimator = O_P(1)` assumption.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_derivativeNormAE_scaledEstimatorLawTail_estimatorSubMeas_rawRoot_rawScoreCLT_envelopeTendsto_summandMeasurable_envelope_absorbing
    {Ω Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace (Coord -> ℝ)]
...
/--
van der Vaart 1998, Theorem 5.41, Z-estimator handoff with canonical raw
score CLT source, with non-circular scaled-estimator tightness.

This absorbing companion plugs the canonical product raw-score CLT directly
into the absorbing derivative-norm Theorem 5.41 handoff.  It keeps the
source-facing law-tail field and no longer routes through an external
`scaledEstimator = O_P(1)` construction.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_canonicalProductRawScoreCLT_derivativeNormAE_scaledEstimatorLawTail_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope_absorbing
    {Ω' Observation Coord Θ : Type*} [Fintype Coord]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
    [SecondCountableTopology (Coord -> ℝ)] [BorelSpace (Coord -> ℝ)]
...
/--
van der Vaart 1998, Theorem 5.41, finite-entry derivative strong-law bound
handoff with explicit `O_P(1)` tightness.

This direct-OP wrapper instantiates the derivative error bound by the finite
sum of absolute centered empirical derivative-entry errors and proves its a.s.
convergence to zero from coordinatewise real strong laws, then feeds the
result into the derivative-bound `StochasticBounded` endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeStrongLawBound_scoreSummandRepresentation_commonVectorLawScoreCLT_scaledEstimatorOP_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Entry Θ : Type*} [Fintype Coord] [Fintype Entry]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
...
/--
van der Vaart 1998, Theorem 5.41, finite-entry derivative action-bound
handoff from displayed `O_P(1)` tightness.

This source-facing wrapper derives the law-tail field for the chosen
a.e. representative `scaledEstimator` from the textbook display
`scale_n • (estimator_n - theta0_n) = O_P(1)`, then calls the absorbing-routed
law-tail action-bound endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_scoreSummandRepresentation_commonVectorLawScoreCLT_displayStochasticBounded_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Entry Θ : Type*} [Fintype Coord] [Fintype Entry]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
    ...
    TendstoInDistribution scaledEstimator atTop
      (fun ω => (-Vinv : (Coord -> ℝ) →L[ℝ] Θ) (Z ω)) (fun _ => P) Q := by
  have hScaledEstimator_lawTail : ∀ ε : ℝ, 0 < ε ->
      ∃ M : ℝ, 0 < M ∧
        ∀ᶠ n in atTop,
          (P.map (scaledEstimator n)).real {x : Θ | M ≤ ‖x‖} < ε :=
    vaart1998_theorem_5_41_scaledEstimator_lawTail_of_displayStochasticBounded_estimatorSubMeas
      scale hTheta0_meas hEstimator_meas hScale_meas
      hScaledEstimator_eq_sub hDisplayOP
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_scoreSummandRepresentation_commonVectorLawScoreCLT_scaledEstimatorLawTail_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      hZ_covariance hScore_vector_law hScore_sequence_law
      hScoreMean_zero hSummand_eq hDerivativeEntry_integrable
      hDerivativeEntry_indep hDerivativeEntry_ident hDerivativeAverage_action_le
      hEstimator_consistency hEnvelope_nonneg hEnvelopeAverage_tendsto
      hScaledEstimator_lawTail hEnvelopeBound
      hDerivativeAtTheta0_summand_meas hSecondDerivative_summand_meas
      hTheta0_meas hEstimator_meas hScale_meas hRawRoot hScore_scaled
...
/--
van der Vaart 1998, Theorem 5.41, finite-entry derivative action-bound
handoff from displayed weak convergence.

This source-facing wrapper derives displayed `O_P(1)` from weak convergence of
`scale_n • (estimator_n - theta0_n)`, then calls the display-tightness
action-bound endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_scoreSummandRepresentation_commonVectorLawScoreCLT_displayWeakTightness_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' ΩT Observation Coord Entry Θ : Type*} [Fintype Coord] [Fintype Entry]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [MeasurableSpace ΩT] {QT : Measure ΩT} [IsProbabilityMeasure QT]
    [PseudoMetricSpace (Coord -> ℝ)]
    [SecondCountableTopology (Coord -> ℝ)] [BorelSpace (Coord -> ℝ)]
    [OpensMeasurableSpace (Coord -> ℝ)] [CompleteSpace (Coord -> ℝ)]
    [NormedAddCommGroup Θ] [NormedSpace ℝ Θ]
    [MeasurableSpace Θ] [SecondCountableTopology Θ] [BorelSpace Θ]
    [OpensMeasurableSpace Θ] [CompleteSpace Θ]
    [MeasurableSub₂ Θ] [MeasurableSMul₂ ℝ Θ]
    [SecondCountableTopology (Θ →L[ℝ] (Coord -> ℝ))]
    [OpensMeasurableSpace (Θ →L[ℝ] (Coord -> ℝ))]
    [MeasurableAdd₂ (Θ →L[ℝ] (Coord -> ℝ))]
    [MeasurableConstSMul ℝ (Θ →L[ℝ] (Coord -> ℝ))]
...
/--
van der Vaart 1998, Theorem 5.41, finite-entry derivative action-bound
handoff from a finite-coordinate score equation.

This source-facing wrapper derives displayed weak convergence from the
common-vector-law finite-coordinate score CLT, a centered finite-coordinate
score equation, and a negligible residual.  It then calls the display
weak-tightness action-bound endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_finiteCoordinateScoreEquation_scoreSummandRepresentation_commonVectorLawScoreCLT_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Entry Θ : Type*} [Fintype Coord] [Fintype Entry]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
  ...
  have hDisplay_tendsto :
    ...
    vaart1998_theorem_5_41_display_tendstoInDistribution_of_finiteCoordinateScoreEquation_commonVectorLawScoreCLT
      (P := P) (Q := Q) (V := V) (Vinv := Vinv) (scale := scale)
      (scoreSummand := scoreSummand) (scoreLaw := scoreLaw)
      (theta0 := theta0) (estimator := estimator)
      (scaledEstimator := scaledEstimator) (residual := residual) (Z := Z)
      hLeftInverse hScoreSummand_meas hZ_aemeas
      hScoreSummand_coordinate_memLp hZ_gaussian hZ_memLp hZ_mean
      hZ_covariance hScore_vector_law hScore_sequence_law hResidual
      hResidual_meas hScoreEquation hScaledEstimator_eq_sub
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_scoreSummandRepresentation_commonVectorLawScoreCLT_displayWeakTightness_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      (theta0 := theta0) (estimator := estimator)
      (delta := delta) (scaledEstimator := scaledEstimator) (Z := Z)
      (displayLimit := fun ω => (-Vinv : (Coord -> ℝ) →L[ℝ] Θ) (Z ω))
      hLeftInverse hScoreSummand_meas hZ_aemeas
      hScoreSummand_coordinate_memLp hZ_gaussian hZ_memLp hZ_mean
      hZ_covariance hScore_vector_law hScore_sequence_law
      hScoreMean_zero hSummand_eq hDerivativeEntry_integrable
      hDerivativeEntry_indep hDerivativeEntry_ident hDerivativeAverage_action_le
      hEstimator_consistency hEnvelope_nonneg hEnvelopeAverage_tendsto
      hDisplay_tendsto hEnvelopeBound
      hDerivativeAtTheta0_summand_meas hSecondDerivative_summand_meas
      hTheta0_meas hEstimator_meas hScale_meas hRawRoot hScore_scaled
      hEstimator_scaled hDelta_eq_sub hScaledEstimator_eq_sub hOpen
      hSegmentSubset hContDiffEstimatingMap hDerivativeAt_eq_fderiv
...
/--
van der Vaart 1998, Theorem 5.41, finite-entry derivative action-bound
handoff from a finite-coordinate Taylor-zero display.

This wrapper converts the textbook Taylor-zero display into the centered
finite-coordinate score equation consumed by the preceding endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_finiteCoordinateTaylorZero_scoreSummandRepresentation_commonVectorLawScoreCLT_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Entry Θ : Type*} [Fintype Coord] [Fintype Entry]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
    ...
    (hTaylorZero : ∀ n : ℕ,
      ∀ᵐ ω ∂P,
        vaart1998_finiteCoordinateScaledCenteredEmpiricalMoment
            P scoreSummand n ω +
          V (scaledEstimator n ω) + residual n ω = 0)
    (hEnvelopeBound : ∀ᶠ n in atTop, ∀ ω x,
      ‖secondDerivative n ω x‖ ≤ envelope x)
    (hDerivativeAtTheta0_summand_meas : ∀ n : ℕ, ∀ i : Fin n,
      AEMeasurable
  ...
  have hScoreEquation : ∀ n : ℕ,
      ∀ᵐ ω ∂P,
        V (scaledEstimator n ω) =
          -(vaart1998_finiteCoordinateScaledCenteredEmpiricalMoment
              P scoreSummand n ω + residual n ω) := by
    intro n
    exact (hTaylorZero n).mono fun ω hω => by
      have hsum :
          V (scaledEstimator n ω) +
              (vaart1998_finiteCoordinateScaledCenteredEmpiricalMoment
                P scoreSummand n ω + residual n ω) = 0 := by
        simpa [add_assoc, add_comm, add_left_comm] using hω
      exact add_eq_zero_iff_eq_neg.mp hsum
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_finiteCoordinateScoreEquation_scoreSummandRepresentation_commonVectorLawScoreCLT_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      hDerivativeEntry_indep hDerivativeEntry_ident hDerivativeAverage_action_le
      hEstimator_consistency hEnvelope_nonneg hEnvelopeAverage_tendsto
      hResidual hResidual_meas hScoreEquation hEnvelopeBound
      hDerivativeAtTheta0_summand_meas hSecondDerivative_summand_meas
      hTheta0_meas hEstimator_meas hScale_meas hRawRoot hScore_scaled
      hEstimator_scaled hDelta_eq_sub hScaledEstimator_eq_sub hOpen
      hSegmentSubset hContDiffEstimatingMap hDerivativeAt_eq_fderiv
...
/--
van der Vaart 1998, Theorem 5.41, score average representation as a scaled
centered finite-coordinate empirical moment.

This is the observation-level score version of
`vaart1998_theorem_5_41_rawScore_eq_finiteCoordinateScaledCentered_of_summand_eq`.
It first rewrites `scoreAtTheta0` to the scaled raw estimating-map summand,
then applies the finite-coordinate summand representation.
-/
theorem vaart1998_theorem_5_41_scoreAverage_eq_finiteCoordinateScaledCentered_of_summand_eq_scoreScaled
    {Ω Observation Coord Θ : Type*} [Fintype Coord] [MeasurableSpace Ω]
    {P : Measure Ω}
    (samples : ∀ n : ℕ, Ω -> SampleAt Observation n)
    (scale : ℕ -> Ω -> ℝ)
    (estimatingMap : ℕ -> Ω -> Observation -> Θ -> Coord -> ℝ)
    (scoreAtTheta0 : ℕ -> Ω -> Observation -> Coord -> ℝ)
    (theta0 : ℕ -> Ω -> Θ)
    (scoreSummand : Coord -> ℕ -> Ω -> ℝ)
    (hScoreMean_zero : ∀ coordinate : Coord,
      (∫ ω, scoreSummand coordinate 0 ω ∂P) = 0)
  ...
  have hScore_eq_raw :
      (fun ω =>
        ...
        fun ω =>
          empiricalAverageVector (samples n ω)
            (fun x => scale n ω • estimatingMap n ω x (theta0 n ω)) := by
    exact (hScore_scaled n).mono fun ω hω => by
      simp [empiricalAverageVector, hω]
  exact hScore_eq_raw.trans (hRawScore_eq_finiteCoordinate n)

/--
van der Vaart 1998, Theorem 5.41, finite-coordinate Taylor-zero display from
the raw root equation and Taylor expansion.

This is the finite-coordinate analogue of
`vaart1998_theorem_5_41_taylorEquation_of_root_taylorExpansion`: the raw root
`Psi_n(thetaHat_n) = 0` and the Taylor identity for that same quantity produce
the Taylor-zero display consumed by the finite-coordinate action endpoint.
-/
theorem vaart1998_theorem_5_41_finiteCoordinateTaylorZero_of_root_taylorExpansion
    {Ω Coord Θ : Type*} [MeasurableSpace Ω] {P : Measure Ω}
    [NormedAddCommGroup Θ] [NormedSpace ℝ Θ]
    (V : Θ →L[ℝ] (Coord -> ℝ))
    {score estimatingEquationAtEstimator residual : ℕ -> Ω -> Coord -> ℝ}
    {scaledEstimator : ℕ -> Ω -> Θ}
    (hRoot : ∀ n : ℕ,
      ∀ᵐ ω ∂P, estimatingEquationAtEstimator n ω = 0)
    (hTaylorExpansion : ∀ n : ℕ,
      ∀ᵐ ω ∂P,
        score n ω + V (scaledEstimator n ω) + residual n ω =
          estimatingEquationAtEstimator n ω) :
    ∀ n : ℕ,
      ∀ᵐ ω ∂P,
        score n ω + V (scaledEstimator n ω) + residual n ω = 0 := by
...
/--
van der Vaart 1998, Theorem 5.41, finite-entry derivative action-bound
handoff from a finite-coordinate raw root and Taylor expansion.

This source-facing wrapper derives the finite-coordinate Taylor-zero display
from the raw root equation and Taylor expansion, then calls the finite
Taylor-zero action-bound endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_finiteCoordinateRootTaylor_scoreSummandRepresentation_commonVectorLawScoreCLT_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Entry Θ : Type*} [Fintype Coord] [Fintype Entry]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
    ...
    {scoreLaw : Measure (Coord -> ℝ)}
    {theta0 estimator delta scaledEstimator : ℕ -> Ω -> Θ}
    {estimatingEquationAtEstimator residual : ℕ -> Ω -> Coord -> ℝ}
    {Z : Ω' -> Coord -> ℝ}
    (hLeftInverse : ∀ x : Θ, Vinv (V x) = x)
    (hScoreSummand_meas : ∀ coordinate i, Measurable (scoreSummand coordinate i))
    (hZ_aemeas : AEMeasurable Z Q)
    ...
    vaart1998_theorem_5_41_finiteCoordinateTaylorZero_of_root_taylorExpansion
      ...
      (score := fun n ω =>
        vaart1998_finiteCoordinateScaledCenteredEmpiricalMoment
          P scoreSummand n ω)
      (estimatingEquationAtEstimator := estimatingEquationAtEstimator)
      (residual := residual) (scaledEstimator := scaledEstimator)
      hRoot hTaylorExpansion
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_finiteCoordinateTaylorZero_scoreSummandRepresentation_commonVectorLawScoreCLT_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      hDerivativeEntry_indep hDerivativeEntry_ident hDerivativeAverage_action_le
      hEstimator_consistency hEnvelope_nonneg hEnvelopeAverage_tendsto
      hResidual hResidual_meas hTaylorZero hEnvelopeBound
      hDerivativeAtTheta0_summand_meas hSecondDerivative_summand_meas
      hTheta0_meas hEstimator_meas hScale_meas hRawRoot hScore_scaled
      hEstimator_scaled hDelta_eq_sub hScaledEstimator_eq_sub hOpen
      hSegmentSubset hContDiffEstimatingMap hDerivativeAt_eq_fderiv
...
/--
van der Vaart 1998, Theorem 5.41, finite-entry derivative action-bound
handoff from sampled pointwise Taylor identities and a residual definition.

This wrapper packages the currently preferred source route: the raw root and
scaled estimator equation give the root for the scaled empirical equation,
while the sampled Taylor identity, score-summand representation, and residual
definition give the finite-coordinate Taylor expansion consumed by the
root-Taylor endpoint.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_pointwiseTaylorResidual_scoreSummandRepresentation_commonVectorLawScoreCLT_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Entry Θ : Type*} [Fintype Coord] [Fintype Entry]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
  ...
  have hRoot : ∀ n : ℕ,
    ...
    vaart1998_theorem_5_41_estimatingEquationRoot_of_rawRoot_estimatorScaled
      ...
      (estimatingMap := estimatingMap)
      (estimatingAtEstimator := estimatingAtEstimator)
      (estimator := estimator) hRawRoot hEstimator_scaled
  have hScoreAverage_eq_finiteCoordinate : ∀ n : ℕ,
      (fun ω =>
        empiricalAverageVector (samples n ω) (scoreAtTheta0 n ω)) =ᵐ[P]
        fun ω => vaart1998_finiteCoordinateScaledCenteredEmpiricalMoment
          P scoreSummand n ω :=
    vaart1998_theorem_5_41_scoreAverage_eq_finiteCoordinateScaledCentered_of_summand_eq_scoreScaled
      (P := P) (samples := samples) (scale := scale)
      (estimatingMap := estimatingMap) (scoreAtTheta0 := scoreAtTheta0)
      (theta0 := theta0) (scoreSummand := scoreSummand)
      hScoreMean_zero hSummand_eq hScore_scaled
  have hTaylorExpansion : ∀ n : ℕ,
      ∀ᵐ ω ∂P,
        vaart1998_finiteCoordinateScaledCenteredEmpiricalMoment
            P scoreSummand n ω +
    ...
    vaart1998_theorem_5_41_finiteCoordinateTaylorExpansion_of_pointwiseTaylor_residual
      ...
      (scoreAtTheta0 := scoreAtTheta0)
      (estimatingAtEstimator := estimatingAtEstimator)
      (derivativeAt := fun n ω y => derivativeAt n ω y (theta0 n ω))
      (secondDerivative := secondDerivative)
      (scoreSummand := scoreSummand) (delta := delta)
      (scaledEstimator := scaledEstimator) (residual := residual)
      hScoreAverage_eq_finiteCoordinate hResidual_eq hPointwiseTaylor
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_finiteCoordinateRootTaylor_scoreSummandRepresentation_commonVectorLawScoreCLT_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      hDerivativeEntry_indep hDerivativeEntry_ident hDerivativeAverage_action_le
      hEstimator_consistency hEnvelope_nonneg hEnvelopeAverage_tendsto
      hResidual hResidual_meas hRoot hTaylorExpansion hEnvelopeBound
      hDerivativeAtTheta0_summand_meas hSecondDerivative_summand_meas
      hTheta0_meas hEstimator_meas hScale_meas hRawRoot hScore_scaled
      hEstimator_scaled hDelta_eq_sub hScaledEstimator_eq_sub hOpen
      hSegmentSubset hContDiffEstimatingMap hDerivativeAt_eq_fderiv
...
/--
van der Vaart 1998, Theorem 5.41, pointwise-Taylor residual source handoff
with explicit `O_P(1)` tightness.

This wrapper removes the auxiliary residual convergence and residual
measurability fields from the pointwise-Taylor source endpoint.  The residual is
defined literally as the empirical-derivative error plus the quadratic Taylor
term, and the residual source package proves its negligibility and
a.e.-measurability from the derivative LLN, consistency, the second-derivative
envelope, and `scaledEstimator = O_P(1)`.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_pointwiseTaylorResidualSource_scoreSummandRepresentation_commonVectorLawScoreCLT_scaledEstimatorOP_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Entry Θ : Type*} [Fintype Coord] [Fintype Entry]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
    ...
    TendstoInDistribution scaledEstimator atTop
      (fun ω => (-Vinv : (Coord -> ℝ) →L[ℝ] Θ) (Z ω)) (fun _ => P) Q := by
  let empiricalDerivative : ℕ -> Ω -> Θ →L[ℝ] (Coord -> ℝ) :=
    fun n ω =>
      empiricalAverageVector (samples n ω)
        (fun y => derivativeAt n ω y (theta0 n ω))
  let secondDerivativeAction :
      ℕ -> Ω -> Θ →L[ℝ] Θ →L[ℝ] (Coord -> ℝ) :=
    fun n ω => empiricalAverageVector (samples n ω) (secondDerivative n ω)
  let curvatureBound : ℕ -> Ω -> ℝ :=
    fun n ω => empiricalAverage (samples n ω) envelope
  let residual : ℕ -> Ω -> Coord -> ℝ :=
    fun n ω =>
      (empiricalDerivative n ω - V) (scaledEstimator n ω) +
        (1 / 2 : ℝ) •
          secondDerivativeAction n ω (delta n ω) (scaledEstimator n ω)
  ...
  have hDerivativeAverage_norm_ae :
      ∀ᵐ ω ∂P,
        Tendsto (fun n : ℕ => ‖empiricalDerivative n ω - V‖)
          atTop (𝓝 0) :=
    vaart1998_theorem_5_41_derivativeAverage_norm_tendsto_ae_of_eventual_bound
      (P := P) (V := V) (samples := samples)
      (derivativeAt := derivativeAt) (theta0 := theta0)
  ...
  have hEmpiricalDerivative_meas :
      ∀ n,
        AEMeasurable (empiricalDerivative n) P :=
    vaart1998_theorem_5_41_empiricalDerivative_aemeasurable_of_summands
      (P := P) (samples := samples) (derivativeAt := derivativeAt)
      (theta0 := theta0) hDerivativeAtTheta0_summand_meas
  have hDerivativeNorm_strongMeas :
      ∀ n : ℕ,
        AEStronglyMeasurable
          (fun ω => ‖empiricalDerivative n ω - V‖) P := by
    intro n
    have hDerivativeDiff :
        AEMeasurable (fun ω => empiricalDerivative n ω - V) P :=
      (continuous_id.sub continuous_const).measurable.comp_aemeasurable
        (hEmpiricalDerivative_meas n)
    exact
      (continuous_norm.measurable.comp_aemeasurable
        hDerivativeDiff).aestronglyMeasurable
  have hDerivativeLLN :
      TendstoInMeasure P
        (fun n ω => ‖empiricalDerivative n ω - V‖) atTop 0 :=
    vaart1998_tendstoInMeasure_of_tendsto_ae
      (P := P)
      (X := fun n ω => ‖empiricalDerivative n ω - V‖)
      (Z := fun _ : Ω => (0 : ℝ))
      hDerivativeNorm_strongMeas hDerivativeAverage_norm_ae
  have hDelta :
      TendstoInMeasure P (fun n ω => ‖delta n ω‖) atTop 0 :=
    hEstimator_consistency.congr (fun n =>
      (hDelta_eq_sub n).mono fun ω hω => by
        rw [← hω]) Filter.EventuallyEq.rfl
  have hCurvatureBounded : StochasticBounded P curvatureBound :=
    vaart1998_stochasticBounded_of_tendstoInMeasure_const
      envelopeMean hEnvelopeAverage_tendsto
  have hCurvatureOpBound : ∀ᶠ n in atTop, ∀ ω,
      ‖secondDerivativeAction n ω‖ ≤ ‖curvatureBound n ω‖ :=
  ...
  have hSecondDerivativeAction_meas :
      ∀ n,
        AEMeasurable (secondDerivativeAction n) P :=
    vaart1998_theorem_5_41_empiricalSecondDerivativeAction_aemeasurable_of_summands
      (P := P) (samples := samples) (secondDerivative := secondDerivative)
      hSecondDerivative_summand_meas
  have hDelta_meas : ∀ n, AEMeasurable (delta n) P := by
  ...
  have hScaledEstimator_meas : ∀ n, AEMeasurable (scaledEstimator n) P := by
    ...
    exact ((hScale_meas n).smul ((hEstimator_meas n).sub (hTheta0_meas n))).congr
      ((hScaledEstimator_eq_sub n).mono fun ω hω => hω.symm)
  have hResidual_source :
      TendstoInMeasure P residual atTop 0 ∧
        ∀ n, AEMeasurable (residual n) P :=
    vaart1998_theorem_5_41_residual_tendstoInMeasure_and_aemeasurable_of_derivativeLLN_secondDerivativeBound
      (P := P) (empiricalDerivative := empiricalDerivative) V
      (secondDerivativeAction := secondDerivativeAction)
      (delta := delta) (scaledEstimator := scaledEstimator)
      (curvatureBound := curvatureBound) hDerivativeLLN hDelta
      hCurvatureBounded hScaledEstimator hCurvatureOpBound
      hEmpiricalDerivative_meas hSecondDerivativeAction_meas hDelta_meas
      hScaledEstimator_meas
  have hResidual_eq : ∀ n : ℕ,
      ∀ᵐ ω ∂P,
        residual n ω =
          (empiricalAverageVector (samples n ω)
              (fun y => derivativeAt n ω y (theta0 n ω)) - V)
  ...
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_pointwiseTaylorResidual_scoreSummandRepresentation_commonVectorLawScoreCLT_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      hDerivativeEntry_indep hDerivativeEntry_ident hDerivativeAverage_action_le
      hEstimator_consistency hEnvelope_nonneg hEnvelopeAverage_tendsto
      hResidual_source.1 hResidual_source.2 hResidual_eq hPointwiseTaylor
      hEnvelopeBound hDerivativeAtTheta0_summand_meas
        hSecondDerivative_summand_meas hTheta0_meas hEstimator_meas
        hScale_meas hRawRoot hScore_scaled hEstimator_scaled hDelta_eq_sub
        hScaledEstimator_eq_sub hOpen hSegmentSubset hContDiffEstimatingMap
        hDerivativeAt_eq_fderiv hContDiffDerivativeAt
        hSecondDerivative_eq_fderiv

/--
van der Vaart 1998, Theorem 5.41, pointwise-Taylor residual source handoff
from the absorbing tightness route.

The non-circular absorbing route proves weak convergence of the selected
scaled estimator before the residual-source package is invoked.  This wrapper
uses that weak-convergence output only to recover `scaledEstimator = O_P(1)`,
then feeds the direct residual-source endpoint above.  It is the intended
handoff between the absorbing bootstrap stack and the newer residual-source
statement.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_pointwiseTaylorResidualSource_scoreSummandRepresentation_commonVectorLawScoreCLT_absorbingTightness_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Entry Θ : Type*} [Fintype Coord] [Fintype Entry]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
    ...
    TendstoInDistribution scaledEstimator atTop
      (fun ω => (-Vinv : (Coord -> ℝ) →L[ℝ] Θ) (Z ω)) (fun _ => P) Q := by
  have hScaledEstimator : StochasticBounded P scaledEstimator :=
    vaart1998_stochasticBounded_of_tendstoInDistribution hAbsorbingTightness
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_pointwiseTaylorResidualSource_scoreSummandRepresentation_commonVectorLawScoreCLT_scaledEstimatorOP_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      hDerivativeEntry_indep hDerivativeEntry_ident hDerivativeAverage_action_le
      hEstimator_consistency hEnvelope_nonneg hEnvelopeAverage_tendsto
      hScaledEstimator hPointwiseTaylor hEnvelopeBound
      hDerivativeAtTheta0_summand_meas hSecondDerivative_summand_meas
      hTheta0_meas hEstimator_meas hScale_meas hRawRoot hScore_scaled
      hEstimator_scaled hDelta_eq_sub hScaledEstimator_eq_sub hOpen
      hSegmentSubset hContDiffEstimatingMap hDerivativeAt_eq_fderiv
...
/--
van der Vaart 1998, Theorem 5.41, finite-entry derivative action-bound handoff
with explicit `O_P(1)` tightness.

This is the direct-OP companion to the finite-entry action-bound endpoint
above.  The source-shaped action bound on every nonzero direction is converted
to the operator-norm domination required by the finite strong-law handoff, and
the final Z-estimator endpoint consumes `StochasticBounded` directly.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_scoreSummandRepresentation_commonVectorLawScoreCLT_scaledEstimatorOP_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Entry Θ : Type*} [Fintype Coord] [Fintype Entry]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
  ...
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeStrongLawBound_scoreSummandRepresentation_commonVectorLawScoreCLT_scaledEstimatorOP_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      hDerivativeEntry_indep hDerivativeEntry_ident hDerivativeAverage_norm_le
      hEstimator_consistency hEnvelope_nonneg hEnvelopeAverage_tendsto
      hScaledEstimator hEnvelopeBound
      hDerivativeAtTheta0_summand_meas hSecondDerivative_summand_meas
      hTheta0_meas hEstimator_meas hScale_meas hRawRoot hScore_scaled
      hEstimator_scaled hDelta_eq_sub hScaledEstimator_eq_sub hOpen
      hSegmentSubset hContDiffEstimatingMap hDerivativeAt_eq_fderiv
...
/--
van der Vaart 1998, Theorem 5.41, fully inlined absorbing residual-source
handoff from finite-coordinate score and derivative sources.

This source wrapper removes the remaining explicit absorbing-tightness field
from the residual-source route.  It derives the raw-score CLT from the
common-vector-law finite-coordinate score source, derives the empirical
derivative LLN from the finite derivative action bound, obtains the selected
scaled-estimator weak convergence through the existing absorbing route, and
then feeds the absorbing-tightness residual-source bridge.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_pointwiseTaylorResidualSource_scoreSummandRepresentation_commonVectorLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Entry Θ : Type*} [Fintype Coord] [Fintype Entry]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
  ...
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_pointwiseTaylorResidualSource_scoreSummandRepresentation_commonVectorLawScoreCLT_absorbingTightness_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      hDerivativeEntry_indep hDerivativeEntry_ident hDerivativeAverage_action_le
      hEstimator_consistency hEnvelope_nonneg hEnvelopeAverage_tendsto
      hAbsorbingTightness hPointwiseTaylor hEnvelopeBound
      hDerivativeAtTheta0_summand_meas hSecondDerivative_summand_meas
      hTheta0_meas hEstimator_meas hScale_meas hRawRoot hScore_scaled
      hEstimator_scaled hDelta_eq_sub hScaledEstimator_eq_sub hOpen
      hSegmentSubset hContDiffEstimatingMap hDerivativeAt_eq_fderiv
...
/--
van der Vaart 1998, Theorem 5.41, derivative common-vector law from a
table-valued derivative representation.

This transfers the derivative-entry common law and infinite-product law from
the model-facing derivative table process to the finite-coordinate
`derivativeEntry` packaging used by the compiled derivative LLN route.
-/
theorem vaart1998_theorem_5_41_derivativeCommonVectorLaw_of_matrixTableRepresentation
    {Ω Coord Param : Type*} [MeasurableSpace Ω]
    [MeasurableSpace (Coord × Param -> ℝ)]
    (derivativeEntry : Coord -> Param -> ℕ -> Ω -> ℝ)
    (derivativeTable : ℕ -> Ω -> Coord × Param -> ℝ)
    {derivativeLaw : Measure (Coord × Param -> ℝ)} {P : Measure Ω}
    (hDerivativeEntry_eq_table : ∀ coordinate param i ω,
      derivativeEntry coordinate param i ω =
        derivativeTable i ω (coordinate, param))
    (hDerivativeTable_law : ∀ i : ℕ,
      _root_.ProbabilityTheory.HasLaw (derivativeTable i) derivativeLaw P)
    ...
    _root_.ProbabilityTheory.HasLaw
      (fun ω i =>
        vaart1998_finiteCoordinateSampleVector
          (fun entry i ω => derivativeEntry entry.1 entry.2 i ω) i ω)
      (Measure.infinitePi (fun _ : ℕ => derivativeLaw)) P := by
  refine ⟨?_, ?_⟩
  · intro i
    refine (hDerivativeTable_law i).congr ?_
    filter_upwards [] with ω
    funext entry
    simpa [vaart1998_finiteCoordinateSampleVector] using
      hDerivativeEntry_eq_table entry.1 entry.2 i ω
  · refine hDerivativeTable_sequence_law.congr ?_
    filter_upwards [] with ω
    funext i entry
    simpa [vaart1998_finiteCoordinateSampleVector] using
      hDerivativeEntry_eq_table entry.1 entry.2 i ω
...
/--
van der Vaart 1998, Theorem 5.41, score-law moment source for finite
coordinates.

If the finite score-vector summands have common law `scoreLaw`, then
coordinate `L²` and zero-mean assumptions can be stated under `scoreLaw`
itself.  This transfers those moment fields to the concrete score summands on
the sample space, matching the hypotheses consumed by the finite-coordinate
score CLT wrappers.
-/
theorem vaart1998_theorem_5_41_scoreSummand_coordinate_memLp_mean_zero_of_commonVectorLaw
    {Ω Coord : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace (Coord -> ℝ)]
    (scoreSummand : Coord -> ℕ -> Ω -> ℝ)
    {scoreLaw : Measure (Coord -> ℝ)}
    (hScoreCoordinate_meas : ∀ coordinate : Coord,
      Measurable (fun sampleVector : Coord -> ℝ => sampleVector coordinate))
    (hScoreLaw_coordinate_memLp : ∀ coordinate : Coord,
      MemLp (fun sampleVector : Coord -> ℝ => sampleVector coordinate) 2
        scoreLaw)
    (hScoreLaw_mean_zero : ∀ coordinate : Coord,
      (∫ sampleVector, sampleVector coordinate ∂scoreLaw) = 0)
    (hScore_vector_law : ∀ i : ℕ,
      _root_.ProbabilityTheory.HasLaw
        (vaart1998_finiteCoordinateSampleVector scoreSummand i) scoreLaw P) :
    (∀ coordinate : Coord, MemLp (scoreSummand coordinate 0) 2 P) ∧
    (∀ coordinate : Coord, (∫ ω, scoreSummand coordinate 0 ω ∂P) = 0) := by
  let sampleVector0 : Ω -> Coord -> ℝ :=
    vaart1998_finiteCoordinateSampleVector scoreSummand 0
  have hVector_ident :
      _root_.ProbabilityTheory.IdentDistrib sampleVector0
        (id : (Coord -> ℝ) -> Coord -> ℝ) P scoreLaw :=
    _root_.ProbabilityTheory.HasLaw.identDistrib
      (hScore_vector_law 0)
      (_root_.ProbabilityTheory.HasLaw.id :
        _root_.ProbabilityTheory.HasLaw
          (id : (Coord -> ℝ) -> Coord -> ℝ) scoreLaw scoreLaw)
  refine ⟨?_, ?_⟩
  · intro coordinate
    have hCoordinate_ident :
        _root_.ProbabilityTheory.IdentDistrib
          (fun ω => sampleVector0 ω coordinate)
          (fun sampleVector : Coord -> ℝ => sampleVector coordinate)
          P scoreLaw :=
      hVector_ident.comp (hScoreCoordinate_meas coordinate)
    have hmem :
        MemLp (fun ω => sampleVector0 ω coordinate) 2 P :=
      hCoordinate_ident.symm.memLp_snd
        (hScoreLaw_coordinate_memLp coordinate)
    simpa [sampleVector0, vaart1998_finiteCoordinateSampleVector] using hmem
  · intro coordinate
    have hCoordinate_ident :
        _root_.ProbabilityTheory.IdentDistrib
          (fun ω => sampleVector0 ω coordinate)
      ...
      hVector_ident.comp (hScoreCoordinate_meas coordinate)
    have hmean :
        (∫ ω, sampleVector0 ω coordinate ∂P) =
          ∫ sampleVector, sampleVector coordinate ∂scoreLaw :=
      hCoordinate_ident.integral_eq
    simpa [sampleVector0, vaart1998_finiteCoordinateSampleVector,
      hScoreLaw_mean_zero coordinate] using hmean

/--
van der Vaart 1998, Theorem 5.41, score-law projected variance source.

The common vector law for the finite score summands also transfers projected
variances: testing the sample-space score vector by any continuous linear
functional has the same variance as testing the common score law by that
functional.  This is the covariance-source bridge needed to state the Gaussian
limit covariance under `scoreLaw`.
-/
theorem vaart1998_theorem_5_41_scoreLaw_projectedVariance_eq_of_commonVectorLaw
    {Ω Coord : Type*} [Fintype Coord]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace (Coord -> ℝ)]
    [PseudoMetricSpace (Coord -> ℝ)] [BorelSpace (Coord -> ℝ)]
    (scoreSummand : Coord -> ℕ -> Ω -> ℝ)
    {scoreLaw : Measure (Coord -> ℝ)}
    (hScore_vector_law : ∀ i : ℕ,
      _root_.ProbabilityTheory.HasLaw
        (vaart1998_finiteCoordinateSampleVector scoreSummand i) scoreLaw P) :
    ∀ L : StrongDual ℝ (Coord -> ℝ),
      _root_.ProbabilityTheory.variance
        (vaart1998_finiteCoordinateProjectedSample L scoreSummand 0) P =
      _root_.ProbabilityTheory.variance L scoreLaw := by
  intro L
  let sampleVector0 : Ω -> Coord -> ℝ :=
    vaart1998_finiteCoordinateSampleVector scoreSummand 0
  have hVector_ident :
    ...
    _root_.ProbabilityTheory.HasLaw.identDistrib
      ...
      (_root_.ProbabilityTheory.HasLaw.id :
        _root_.ProbabilityTheory.HasLaw
          (id : (Coord -> ℝ) -> Coord -> ℝ) scoreLaw scoreLaw)
  have hProjected_ident :
      _root_.ProbabilityTheory.IdentDistrib
        (fun ω => L (sampleVector0 ω)) L P scoreLaw :=
    hVector_ident.comp L.continuous.measurable
  simpa [sampleVector0, vaart1998_finiteCoordinateProjectedSample,
    Function.comp_def] using hProjected_ident.variance_eq

/--
van der Vaart 1998, Theorem 5.41, score-summand representation from a
vector-valued score representation.

This bridge lets model-specific instantiations state the score linearization
as a vector equality instead of restating it coordinate by coordinate.
-/
theorem vaart1998_theorem_5_41_scoreSummandRepresentation_of_vectorScoreRepresentation
    {Ω Observation Coord Param : Type*} [MeasurableSpace Ω] {P : Measure Ω}
    (samples : ∀ n : ℕ, Ω -> SampleAt Observation n)
    (scale : ℕ -> Ω -> ℝ)
    (estimatingMap :
      ℕ -> Ω -> Observation -> (Param -> ℝ) -> Coord -> ℝ)
    (scoreSummand : Coord -> ℕ -> Ω -> ℝ)
    (scoreVector : ℕ -> Ω -> Coord -> ℝ)
    {theta0 : ℕ -> Ω -> Param -> ℝ}
    (hScoreSummand_eq_vector : ∀ coordinate i ω,
      scoreSummand coordinate i ω = scoreVector i ω coordinate)
    (hScaledScore_vector_eq : ∀ n : ℕ,
      ∀ᵐ ω ∂P, ∀ i : Fin n,
        scale n ω • estimatingMap n ω (samples n ω i) (theta0 n ω) =
    ...
    ∀ n : ℕ,
      ∀ᵐ ω ∂P, ∀ i : Fin n, ∀ coordinate : Coord,
        (scale n ω • estimatingMap n ω (samples n ω i)
          (theta0 n ω)) coordinate =
          √(n : ℝ) * scoreSummand coordinate i.val ω := by
  intro n
  filter_upwards [hScaledScore_vector_eq n] with ω hScaled i coordinate
  have hCoordinate :=
    congrArg (fun v : Coord -> ℝ => v coordinate) (hScaled i)
  simpa [Pi.smul_apply, hScoreSummand_eq_vector coordinate i.val ω] using
    hCoordinate

/--
van der Vaart 1998, Theorem 5.41, common score-vector law from a vector-valued
score representation.

This transfers the single-coordinate score-law and infinite-product score-law
fields from the model-facing score vector to the finite-coordinate
`scoreSummand` packaging used by the compiled CLT route.
-/
theorem vaart1998_theorem_5_41_scoreCommonVectorLaw_of_vectorScoreRepresentation
    {Ω Coord : Type*} [MeasurableSpace Ω]
    (scoreSummand : Coord -> ℕ -> Ω -> ℝ)
    (scoreVector : ℕ -> Ω -> Coord -> ℝ)
    {scoreLaw : Measure (Coord -> ℝ)} {P : Measure Ω}
    (hScoreSummand_eq_vector : ∀ coordinate i ω,
      scoreSummand coordinate i ω = scoreVector i ω coordinate)
    (hScoreVector_law : ∀ i : ℕ,
      _root_.ProbabilityTheory.HasLaw (scoreVector i) scoreLaw P)
    ...
    _root_.ProbabilityTheory.HasLaw
      (fun ω i => vaart1998_finiteCoordinateSampleVector scoreSummand i ω)
      (Measure.infinitePi (fun _ : ℕ => scoreLaw)) P := by
  refine ⟨?_, ?_⟩
  · intro i
    refine (hScoreVector_law i).congr ?_
    filter_upwards [] with ω
    funext coordinate
    simpa [vaart1998_finiteCoordinateSampleVector] using
      hScoreSummand_eq_vector coordinate i ω
  · refine hScoreVector_sequence_law.congr ?_
    filter_upwards [] with ω
    funext i coordinate
    simpa [vaart1998_finiteCoordinateSampleVector] using
      hScoreSummand_eq_vector coordinate i ω
...
For finite-dimensional parameter spaces `Param -> ℝ`, this wrapper replaces
the abstract finite derivative action-bound field in the current
absorbing-source residual endpoint by the row-wise matrix-entry representation
of the empirical derivative residual.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeBound_pointwiseTaylorResidualSource_scoreSummandRepresentation_commonVectorLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    ...
    (hSummand_eq : ∀ n : ℕ,
      ∀ᵐ ω ∂P, ∀ i : Fin n, ∀ coordinate : Coord,
        (scale n ω • estimatingMap n ω (samples n ω i)
          ...
          √(n : ℝ) * scoreSummand coordinate i.val ω)
    (hDerivativeEntry_integrable :
      ∀ coordinate param, Integrable (derivativeEntry coordinate param 0) P)
    (hDerivativeEntry_indep :
      ∀ coordinate param, Pairwise fun i j =>
        _root_.ProbabilityTheory.IndepFun
          (derivativeEntry coordinate param i)
    ...
    (hDerivativeEntry_ident :
      ∀ coordinate param i,
        _root_.ProbabilityTheory.IdentDistrib
          (derivativeEntry coordinate param i)
          (derivativeEntry coordinate param 0) P P)
    ...
    TendstoInDistribution scaledEstimator atTop
      ...
      (fun _ => P) Q := by
  have hDerivativeAverage_action_le :
      ∀ᵐ ω ∂P,
        ∀ᶠ n in atTop,
          ∀ x : Param -> ℝ, ‖x‖ ≠ 0 ->
            ‖(empiricalAverageVector (samples n ω)
    ...
    vaart1998_theorem_5_41_derivativeAverage_action_le_finiteEntryBound_of_matrix_entry_representation
      (P := P) (V := V) (samples := samples)
      (derivativeAt := derivativeAt) (theta0 := theta0)
      (derivativeEntry := derivativeEntry) hDerivativeCoordinate_action_eq
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_finiteDerivativeActionBound_pointwiseTaylorResidualSource_scoreSummandRepresentation_commonVectorLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      (envelope := envelope) (envelopeMean := envelopeMean)
      (scoreSummand := scoreSummand)
      (derivativeEntry := fun entry : Coord × Param =>
        derivativeEntry entry.1 entry.2)
      (theta0 := theta0) (estimator := estimator)
      (delta := delta) (scaledEstimator := scaledEstimator) (Z := Z)
      hLeftInverse hScoreSummand_meas hZ_aemeas
      hScoreSummand_coordinate_memLp hZ_gaussian hZ_memLp hZ_mean
      hZ_covariance hScore_vector_law hScore_sequence_law
      hScoreMean_zero hSummand_eq
      (fun entry => hDerivativeEntry_integrable entry.1 entry.2)
      (fun entry => hDerivativeEntry_indep entry.1 entry.2)
      (fun entry i => hDerivativeEntry_ident entry.1 entry.2 i)
      hDerivativeAverage_action_le hEstimator_consistency hEnvelope_nonneg
      hEnvelopeAverage_tendsto hPointwiseTaylor hEnvelopeBound
      hDerivativeAtTheta0_summand_meas hSecondDerivative_summand_meas
      hTheta0_meas hEstimator_meas hScale_meas hRawRoot hScore_scaled
      hEstimator_scaled hDelta_eq_sub hScaledEstimator_eq_sub hOpen
      hSegmentSubset hContDiffEstimatingMap hDerivativeAt_eq_fderiv
...
This wrapper composes the derivative-entry common-vector-law source helper into
the matrix-entry endpoint, so downstream model statements can provide a common
law for the finite derivative-entry table instead of the three scalar iid LLN
fields separately.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeCommonVectorLaw_pointwiseTaylorResidualSource_scoreSummandRepresentation_commonVectorLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Param : Type*} [Fintype Coord] [Fintype Param]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
  ...
  have hDerivativeSource :=
    vaart1998_theorem_5_41_derivativeEntry_integrable_indep_identDistrib_of_matrix_commonVectorLaw
      ...
      (derivativeLaw := derivativeLaw)
      hDerivativeCoordinate_meas hDerivativeLaw_integrable
      hDerivative_vector_law hDerivative_sequence_law
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeBound_pointwiseTaylorResidualSource_scoreSummandRepresentation_commonVectorLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      hScoreSummand_coordinate_memLp hZ_gaussian hZ_memLp hZ_mean
      hZ_covariance hScore_vector_law hScore_sequence_law
      hScoreMean_zero hSummand_eq hDerivativeSource.1
      hDerivativeSource.2.1 hDerivativeSource.2.2
      hDerivativeCoordinate_action_eq hEstimator_consistency
      hEnvelope_nonneg hEnvelopeAverage_tendsto hPointwiseTaylor
      hEnvelopeBound hDerivativeAtTheta0_summand_meas
      hSecondDerivative_summand_meas hTheta0_meas hEstimator_meas
      hScale_meas hRawRoot hScore_scaled hEstimator_scaled
      hDelta_eq_sub hScaledEstimator_eq_sub hOpen hSegmentSubset
      hContDiffEstimatingMap hDerivativeAt_eq_fderiv
      hContDiffDerivativeAt hSecondDerivative_eq_fderiv

/--
van der Vaart 1998, Theorem 5.41, finite-dimensional matrix-entry derivative
and score-law moment source for the absorbing residual route.

This wrapper composes the finite score-law moment source into the common-law
matrix endpoint.  Downstream model statements can now state coordinate `L²`
and zero-mean assumptions under the common score law, instead of restating the
same moment fields on the ambient sample space.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeCommonVectorLaw_scoreLawMomentSource_pointwiseTaylorResidualSource_scoreSummandRepresentation_commonVectorLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Param : Type*} [Fintype Coord] [Fintype Param]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
    ...
    TendstoInDistribution scaledEstimator atTop
      (fun ω => (-Vinv : (Coord -> ℝ) →L[ℝ] (Param -> ℝ)) (Z ω))
      (fun _ => P) Q := by
  have hScoreMomentSource :=
    vaart1998_theorem_5_41_scoreSummand_coordinate_memLp_mean_zero_of_commonVectorLaw
      (P := P) (scoreSummand := scoreSummand) (scoreLaw := scoreLaw)
      hScoreCoordinate_meas hScoreLaw_coordinate_memLp
      hScoreLaw_mean_zero hScore_vector_law
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeCommonVectorLaw_pointwiseTaylorResidualSource_scoreSummandRepresentation_commonVectorLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      (delta := delta) (scaledEstimator := scaledEstimator) (Z := Z)
      hLeftInverse hScoreSummand_meas hZ_aemeas
      hScoreMomentSource.1 hZ_gaussian hZ_memLp hZ_mean
      hZ_covariance hScore_vector_law hScore_sequence_law
      hScoreMomentSource.2 hSummand_eq hDerivativeCoordinate_meas
      hDerivativeLaw_integrable hDerivative_vector_law
      hDerivative_sequence_law hDerivativeCoordinate_action_eq
      hEstimator_consistency hEnvelope_nonneg hEnvelopeAverage_tendsto
      hPointwiseTaylor hEnvelopeBound hDerivativeAtTheta0_summand_meas
      hSecondDerivative_summand_meas hTheta0_meas hEstimator_meas
      hScale_meas hRawRoot hScore_scaled hEstimator_scaled
      hDelta_eq_sub hScaledEstimator_eq_sub hOpen hSegmentSubset
      hContDiffEstimatingMap hDerivativeAt_eq_fderiv
...
/--
van der Vaart 1998, Theorem 5.41, finite-dimensional matrix-entry derivative,
score-law moment, and score-law covariance source for the absorbing residual
route.

This wrapper states the Gaussian covariance matching under the common score
law itself.  The projected sample-space variance required by the compiled CLT
route is recovered from the common score-vector law.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeCommonVectorLaw_scoreLawCovarianceMomentSource_pointwiseTaylorResidualSource_scoreSummandRepresentation_commonVectorLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Param : Type*} [Fintype Coord] [Fintype Param]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
  ...
  have hScoreVarianceSource :
    ...
    vaart1998_theorem_5_41_scoreLaw_projectedVariance_eq_of_commonVectorLaw
      (P := P) (scoreSummand := scoreSummand) (scoreLaw := scoreLaw)
      hScore_vector_law
  have hZ_covariance : ∀ L : StrongDual ℝ (Coord -> ℝ),
      _root_.ProbabilityTheory.covarianceBilinDual (Q.map Z) L L =
        _root_.ProbabilityTheory.variance
          (vaart1998_finiteCoordinateProjectedSample L scoreSummand 0) P := by
    intro L
    exact (hZ_covariance_scoreLaw L).trans (hScoreVarianceSource L).symm
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeCommonVectorLaw_scoreLawMomentSource_pointwiseTaylorResidualSource_scoreSummandRepresentation_commonVectorLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      (theta0 := theta0) (estimator := estimator)
      (delta := delta) (scaledEstimator := scaledEstimator) (Z := Z)
      hLeftInverse hScoreCoordinate_meas hScoreSummand_meas hZ_aemeas
      hScoreLaw_coordinate_memLp hScoreLaw_mean_zero hZ_gaussian
      hZ_memLp hZ_mean hZ_covariance hScore_vector_law
      hScore_sequence_law hSummand_eq hDerivativeCoordinate_meas
      hDerivativeLaw_integrable hDerivative_vector_law
      hDerivative_sequence_law hDerivativeCoordinate_action_eq
      hEstimator_consistency hEnvelope_nonneg hEnvelopeAverage_tendsto
      hPointwiseTaylor hEnvelopeBound hDerivativeAtTheta0_summand_meas
...
/--
van der Vaart 1998, Theorem 5.41, finite-dimensional matrix-entry derivative,
score-law moment, score-law covariance, and vector score-representation source
for the absorbing residual route.

This is the current model-facing endpoint for the finite-dimensional route:
the score linearization is supplied as a vector equality, while the compiled
proof still consumes the coordinatewise score-summand representation.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeCommonVectorLaw_scoreLawCovarianceMomentSource_pointwiseTaylorResidualSource_vectorScoreRepresentation_commonVectorLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Param : Type*} [Fintype Coord] [Fintype Param]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
  ...
  have hSummand_eq :=
    vaart1998_theorem_5_41_scoreSummandRepresentation_of_vectorScoreRepresentation
      (P := P) (samples := samples) (scale := scale)
      (estimatingMap := estimatingMap) (scoreSummand := scoreSummand)
      (scoreVector := scoreVector) (theta0 := theta0)
      hScoreSummand_eq_vector hScaledScore_vector_eq
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeCommonVectorLaw_scoreLawCovarianceMomentSource_pointwiseTaylorResidualSource_scoreSummandRepresentation_commonVectorLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      hLeftInverse hScoreCoordinate_meas hScoreSummand_meas hZ_aemeas
      hScoreLaw_coordinate_memLp hScoreLaw_mean_zero hZ_gaussian
      hZ_memLp hZ_mean hZ_covariance_scoreLaw hScore_vector_law
      hScore_sequence_law hSummand_eq hDerivativeCoordinate_meas
      hDerivativeLaw_integrable hDerivative_vector_law
      hDerivative_sequence_law hDerivativeCoordinate_action_eq
      hEstimator_consistency hEnvelope_nonneg hEnvelopeAverage_tendsto
...
/--
van der Vaart 1998, Theorem 5.41, finite-dimensional matrix-entry derivative,
score-law moment, score-law covariance, vector score-representation, and vector
score common-law source for the absorbing residual route.

This wrapper lets model-specific statements provide the common law of the
score vector process itself; the finite-coordinate `scoreSummand` laws needed
by the compiled CLT route are transferred from the vector representation.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeCommonVectorLaw_scoreLawCovarianceMomentSource_pointwiseTaylorResidualSource_vectorScoreRepresentation_vectorScoreCommonLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Param : Type*} [Fintype Coord] [Fintype Param]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
    ...
    TendstoInDistribution scaledEstimator atTop
      (fun ω => (-Vinv : (Coord -> ℝ) →L[ℝ] (Param -> ℝ)) (Z ω))
      (fun _ => P) Q := by
  have hScoreCommonLaw :=
    vaart1998_theorem_5_41_scoreCommonVectorLaw_of_vectorScoreRepresentation
      (P := P) (scoreSummand := scoreSummand)
      (scoreVector := scoreVector) (scoreLaw := scoreLaw)
      hScoreSummand_eq_vector hScoreVector_law hScoreVector_sequence_law
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeCommonVectorLaw_scoreLawCovarianceMomentSource_pointwiseTaylorResidualSource_vectorScoreRepresentation_commonVectorLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      (sourceSet := sourceSet)
      (envelope := envelope) (envelopeMean := envelopeMean)
      (scoreSummand := scoreSummand) (scoreVector := scoreVector)
      (derivativeEntry := derivativeEntry) (scoreLaw := scoreLaw)
      (derivativeLaw := derivativeLaw) (theta0 := theta0)
      (estimator := estimator) (delta := delta)
      (scaledEstimator := scaledEstimator) (Z := Z)
      hLeftInverse hScoreCoordinate_meas hScoreSummand_meas hZ_aemeas
      hScoreLaw_coordinate_memLp hScoreLaw_mean_zero hZ_gaussian
      hZ_memLp hZ_mean hZ_covariance_scoreLaw hScoreCommonLaw.1
      hScoreCommonLaw.2 hScoreSummand_eq_vector hScaledScore_vector_eq
      hDerivativeCoordinate_meas hDerivativeLaw_integrable
      hDerivative_vector_law hDerivative_sequence_law
      hDerivativeCoordinate_action_eq hEstimator_consistency
      hEnvelope_nonneg hEnvelopeAverage_tendsto hPointwiseTaylor
...
/--
van der Vaart 1998, Theorem 5.41, finite-dimensional matrix-entry derivative,
derivative-table common law, score-law moment, score-law covariance, vector
score-representation, and vector score common-law source for the absorbing
residual route.

This wrapper lets model-specific statements provide the common law of the
derivative table process itself; the finite-coordinate derivative-entry laws
needed by the compiled derivative LLN route are transferred from the table
representation.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeTableCommonVectorLaw_scoreLawCovarianceMomentSource_pointwiseTaylorResidualSource_vectorScoreRepresentation_vectorScoreCommonLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Param : Type*} [Fintype Coord] [Fintype Param]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
  ...
  have hDerivativeCommonLaw :=
    vaart1998_theorem_5_41_derivativeCommonVectorLaw_of_matrixTableRepresentation
      (P := P) (derivativeEntry := derivativeEntry)
      (derivativeTable := derivativeTable) (derivativeLaw := derivativeLaw)
      hDerivativeEntry_eq_table hDerivativeTable_law
      hDerivativeTable_sequence_law
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeCommonVectorLaw_scoreLawCovarianceMomentSource_pointwiseTaylorResidualSource_vectorScoreRepresentation_vectorScoreCommonLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      hLeftInverse hScoreCoordinate_meas hScoreSummand_meas hZ_aemeas
      hScoreLaw_coordinate_memLp hScoreLaw_mean_zero hZ_gaussian
      hZ_memLp hZ_mean hZ_covariance_scoreLaw hScoreVector_law
      hScoreVector_sequence_law hScoreSummand_eq_vector
      hScaledScore_vector_eq hDerivativeCoordinate_meas
      hDerivativeLaw_integrable hDerivativeCommonLaw.1
      hDerivativeCommonLaw.2 hDerivativeCoordinate_action_eq
      hEstimator_consistency hEnvelope_nonneg hEnvelopeAverage_tendsto
      hPointwiseTaylor hEnvelopeBound hDerivativeAtTheta0_summand_meas
      hSecondDerivative_summand_meas hTheta0_meas hEstimator_meas
      hScale_meas hRawRoot hScore_scaled hEstimator_scaled hDelta_eq_sub
...
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeTableCommonVectorLaw_scoreLawCovarianceMomentSource_scoreAtTheta0VectorSource_estimatingMapContDiffTaylorSource_vectorScoreRepresentation_vectorScoreCommonLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
  ...
  have hScaledEstimator_eq : ∀ n : ℕ,
      ∀ᵐ ω ∂P, scaledEstimator n ω = scale n ω • delta n ω := by
    intro n
    filter_upwards [hScaledEstimator_eq_sub n, hDelta_eq_sub n] with
      ω hscaled hdelta
    simpa [hdelta] using hscaled
  have hPointwiseTaylor : ∀ n : ℕ,
      ∀ᵐ ω ∂P, ∀ i : Fin n,
    ...
    vaart1998_theorem_5_41_pointwise_scaledTaylorIdentity_ae_of_unscaled_selectedTaylor
      (P := P) (samples := samples) (scale := scale)
      (rawAtTheta0 := fun n ω x => estimatingMap n ω x (theta0 n ω))
      (rawAtEstimator := fun n ω x => estimatingMap n ω x (estimator n ω))
      (scoreAtTheta0 := scoreAtTheta0)
      (estimatingAtEstimator := estimatingAtEstimator)
      (derivative := fun n ω x => derivativeAt n ω x (theta0 n ω))
      (secondDerivative := secondDerivative)
      (delta := delta) (scaledEstimator := scaledEstimator)
      hScore_scaled hEstimator_scaled hScaledEstimator_eq hRawPointwiseTaylor
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeTableCommonVectorLaw_scoreLawCovarianceMomentSource_pointwiseTaylorResidualSource_vectorScoreRepresentation_vectorScoreCommonLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      (scoreSummand := scoreSummand) (scoreVector := scoreVector)
      (derivativeEntry := derivativeEntry)
      (derivativeTable := derivativeTable) (scoreLaw := scoreLaw)
      (derivativeLaw := derivativeLaw) (theta0 := theta0)
      (estimator := estimator) (delta := delta)
      (scaledEstimator := scaledEstimator) (Z := Z)
      hLeftInverse hScoreCoordinate_meas hScoreSummand_meas hZ_aemeas
...
/--
van der Vaart 1998, Theorem 5.41, current finite-dimensional endpoint with
model-definition sources for the selected estimator quantities.

This wrapper keeps the current score, derivative-table, smooth Taylor, and
matrix-action source interface, but replaces three a.e. equality fields by
pointwise model definitions:

* `estimatingAtEstimator` is the scaled estimating map at the estimator;
* `delta` is the estimator increment `estimator - theta0`;
* `scaledEstimator` is the scaled estimator increment.

The previous endpoint still consumes the a.e. forms, and this wrapper derives
them by `ae_of_all`.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeTableCommonVectorLaw_scoreLawCovarianceMomentSource_scoreAtTheta0VectorSource_estimatingMapContDiffTaylorSource_estimatorDefinitionSource_vectorScoreRepresentation_vectorScoreCommonLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Param : Type*} [Fintype Coord] [Fintype Param]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
  ...
  have hEstimator_scaled : ∀ n : ℕ,
    ...
    exact ae_of_all _ fun ω i =>
      hEstimatingAtEstimator_eq_scaled n ω (samples n ω i)
  have hDelta_eq_sub : ∀ n : ℕ,
      ∀ᵐ ω ∂P, delta n ω = estimator n ω - theta0 n ω := by
    intro n
    exact ae_of_all _ fun ω => hDelta_eq_sub_pointwise n ω
  have hScaledEstimator_eq_sub : ∀ n : ℕ,
      ∀ᵐ ω ∂P,
        scaledEstimator n ω =
          scale n ω • (estimator n ω - theta0 n ω) := by
    intro n
    exact ae_of_all _ fun ω => hScaledEstimator_eq_sub_pointwise n ω
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeTableCommonVectorLaw_scoreLawCovarianceMomentSource_scoreAtTheta0VectorSource_estimatingMapContDiffTaylorSource_vectorScoreRepresentation_vectorScoreCommonLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      hZ_memLp hZ_mean hZ_covariance_scoreLaw hScoreVector_law
      hScoreVector_sequence_law hScoreSummand_eq_vector
      hScaledScore_vector_eq hScoreAtTheta0_vector_eq
      hDerivativeCoordinate_meas hDerivativeLaw_integrable
      hDerivativeTable_law hDerivativeTable_sequence_law
      hDerivativeEntry_eq_table hDerivativeAtTheta0_matrix_action
      hV_matrix_action hEstimator_consistency hEnvelope_nonneg
      hEnvelopeAverage_tendsto hEnvelopeBound hDerivativeAtTheta0_summand_meas
      hSecondDerivative_summand_meas hTheta0_meas hEstimator_meas
      hScale_meas hRawRoot hEstimator_scaled hDelta_eq_sub
      hScaledEstimator_eq_sub hOpen hSegmentSubset hContDiffEstimatingMap
      hDerivativeAt_eq_fderiv hContDiffDerivativeAt
      hSecondDerivative_eq_fderiv
...
/--
van der Vaart 1998, Theorem 5.41, current finite-dimensional endpoint with
model-definition sources for the selected estimator quantities and a pointwise
raw estimating-equation source.

This wrapper replaces the previous a.e. raw-root field by the model-facing
pointwise estimating equation.  The existing endpoint consumes the a.e. field,
which is derived here by `ae_of_all`.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeTableCommonVectorLaw_scoreLawCovarianceMomentSource_scoreAtTheta0VectorSource_estimatingMapContDiffTaylorSource_rawRootSource_estimatorDefinitionSource_vectorScoreRepresentation_vectorScoreCommonLawScoreCLT_absorbingSource_estimatorSubMeas_envelopeTendsto_summandMeasurable_envelope
    {Ω Ω' Observation Coord Param : Type*} [Fintype Coord] [Fintype Param]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
  ...
  have hRawRoot : ∀ n : ℕ,
      ∀ᵐ ω ∂P,
        empiricalAverageVector (samples n ω)
          (fun x => estimatingMap n ω x (estimator n ω)) = 0 := by
    intro n
    exact ae_of_all _ fun ω => hRawRoot_pointwise n ω
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeTableCommonVectorLaw_scoreLawCovarianceMomentSource_scoreAtTheta0VectorSource_estimatingMapContDiffTaylorSource_estimatorDefinitionSource_vectorScoreRepresentation_vectorScoreCommonLawScoreCLT_absorbingSource_estimatorSubMeas_rawRoot_envelopeTendsto_summandMeasurable_envelope
      ...
      hEnvelopeAverage_tendsto hEnvelopeBound hDerivativeAtTheta0_summand_meas
      hSecondDerivative_summand_meas hTheta0_meas hEstimator_meas
      hScale_meas hRawRoot hEstimatingAtEstimator_eq_scaled
      hDelta_eq_sub_pointwise hScaledEstimator_eq_sub_pointwise hOpen
      hSegmentSubset hContDiffEstimatingMap hDerivativeAt_eq_fderiv
      hContDiffDerivativeAt hSecondDerivative_eq_fderiv

/--
van der Vaart 1998, Theorem 5.41, current finite-dimensional endpoint with
model-facing measurability sources.

This wrapper keeps the latest score, derivative-table, smooth Taylor,
raw-root, and estimator-definition source interface, but replaces the remaining
selected `AEMeasurable` fields by ordinary `Measurable` hypotheses.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeTableCommonVectorLaw_scoreLawCovarianceMomentSource_scoreAtTheta0VectorSource_estimatingMapContDiffTaylorSource_measurableSource_rawRootSource_estimatorDefinitionSource_vectorScoreRepresentation_vectorScoreCommonLawScoreCLT_absorbingSource_envelopeTendsto_envelope
    {Ω Ω' Observation Coord Param : Type*} [Fintype Coord] [Fintype Param]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
    ...
    TendstoInDistribution scaledEstimator atTop
      (fun ω => (-Vinv : (Coord -> ℝ) →L[ℝ] (Param -> ℝ)) (Z ω))
      (fun _ => P) Q := by
  have hZ_aemeas : AEMeasurable Z Q := hZ_meas.aemeasurable
  have hDerivativeAtTheta0_summand_meas : ∀ n : ℕ, ∀ i : Fin n,
      AEMeasurable
        (fun ω => derivativeAt n ω (samples n ω i) (theta0 n ω)) P := by
    intro n i
    exact (hDerivativeAtTheta0_summand_measurable n i).aemeasurable
  have hSecondDerivative_summand_meas : ∀ n : ℕ, ∀ i : Fin n,
      AEMeasurable
        (fun ω => secondDerivative n ω (samples n ω i)) P := by
    intro n i
    exact (hSecondDerivative_summand_measurable n i).aemeasurable
  have hTheta0_meas : ∀ n, AEMeasurable (theta0 n) P := by
    intro n
    exact (hTheta0_measurable n).aemeasurable
  have hEstimator_meas : ∀ n, AEMeasurable (estimator n) P := by
    intro n
    exact (hEstimator_measurable n).aemeasurable
  have hScale_meas : ∀ n, AEMeasurable (scale n) P := by
    intro n
    exact (hScale_measurable n).aemeasurable
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeTableCommonVectorLaw_scoreLawCovarianceMomentSource_scoreAtTheta0VectorSource_estimatingMapContDiffTaylorSource_rawRootSource_estimatorDefinitionSource_vectorScoreRepresentation_vectorScoreCommonLawScoreCLT_absorbingSource_estimatorSubMeas_envelopeTendsto_summandMeasurable_envelope
      ...
      hEnvelopeAverage_tendsto hEnvelopeBound hDerivativeAtTheta0_summand_meas
      hSecondDerivative_summand_meas hTheta0_meas hEstimator_meas
      hScale_meas hRawRoot_pointwise hEstimatingAtEstimator_eq_scaled
      hDelta_eq_sub_pointwise hScaledEstimator_eq_sub_pointwise hOpen
      hSegmentSubset hContDiffEstimatingMap hDerivativeAt_eq_fderiv
      hContDiffDerivativeAt hSecondDerivative_eq_fderiv
...
pointwise sampled derivative matrix-action source.

The latest endpoint consumes an a.e.-eventual sampled derivative matrix action.
This wrapper lets model instances state the stronger and usually simpler
pointwise finite-coordinate matrix action, then derives the a.e.-eventual field
by `ae_of_all` and `Eventually.of_forall`.
-/
theorem vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeTableCommonVectorLaw_scoreLawCovarianceMomentSource_scoreAtTheta0VectorSource_estimatingMapContDiffTaylorSource_pointwiseDerivativeMatrixActionSource_measurableSource_rawRootSource_estimatorDefinitionSource_vectorScoreRepresentation_vectorScoreCommonLawScoreCLT_absorbingSource_envelopeTendsto_envelope
    {Ω Ω' Observation Coord Param : Type*} [Fintype Coord] [Fintype Param]
    [MeasurableSpace Ω] {P : Measure Ω} [IsProbabilityMeasure P]
    [MeasurableSpace Ω'] {Q : Measure Ω'} [IsProbabilityMeasure Q]
    [PseudoMetricSpace (Coord -> ℝ)]
    ...
    (hDerivativeEntry_eq_table : ∀ coordinate param i ω,
      derivativeEntry coordinate param i ω =
        derivativeTable i ω (coordinate, param))
    (hDerivativeAtTheta0_matrix_action_pointwise :
      ∀ n : ℕ, ∀ ω, ∀ i : Fin n, ∀ x : Param -> ℝ, ∀ coordinate : Coord,
        derivativeAt n ω (samples n ω i) (theta0 n ω) x coordinate =
          ∑ param : Param,
            x param * derivativeEntry coordinate param i.val ω)
    (hV_matrix_action : ∀ x : Param -> ℝ, ∀ coordinate : Coord,
    ...
    TendstoInDistribution scaledEstimator atTop
      (fun ω => (-Vinv : (Coord -> ℝ) →L[ℝ] (Param -> ℝ)) (Z ω))
      (fun _ => P) Q := by
  have hDerivativeAtTheta0_matrix_action :
      ∀ᵐ ω ∂P,
        ∀ᶠ n in atTop,
          ∀ i : Fin n, ∀ x : Param -> ℝ, ∀ coordinate : Coord,
            derivativeAt n ω (samples n ω i) (theta0 n ω) x coordinate =
    ...
    exact ae_of_all _ fun ω =>
      Eventually.of_forall fun n i x coordinate =>
        hDerivativeAtTheta0_matrix_action_pointwise n ω i x coordinate
  exact
    vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_matrixEntryDerivativeTableCommonVectorLaw_scoreLawCovarianceMomentSource_scoreAtTheta0VectorSource_estimatingMapContDiffTaylorSource_measurableSource_rawRootSource_estimatorDefinitionSource_vectorScoreRepresentation_vectorScoreCommonLawScoreCLT_absorbingSource_envelopeTendsto_envelope
      ...
      (estimator := estimator) (delta := delta)
      (scaledEstimator := scaledEstimator) (Z := Z)
      hLeftInverse hScoreCoordinate_meas hScoreSummand_meas hZ_meas
      hScoreLaw_coordinate_memLp hScoreLaw_mean_zero hZ_gaussian
      hZ_memLp hZ_mean hZ_covariance_scoreLaw hScoreVector_law
      hScoreVector_sequence_law hScoreSummand_eq_vector
      hScaledScore_vector_eq hScoreAtTheta0_vector_eq
      ...
      hV_matrix_action hEstimator_consistency hEnvelope_nonneg
      hEnvelopeAverage_tendsto hEnvelopeBound
      hDerivativeAtTheta0_summand_measurable
      ...
      hScaledEstimator_eq_sub_pointwise hOpen hSegmentSubset
      hContDiffEstimatingMap hDerivativeAt_eq_fderiv
      hContDiffDerivativeAt hSecondDerivative_eq_fderiv
