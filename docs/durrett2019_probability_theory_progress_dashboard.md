...
Route from `Live In-Thread Goal Prompt V56` in
...
obligation: prove the remaining `X = Y/Z` no-`0/0` handoff or `{X = infinity}`
singular separation for these canonical densities.
