...
Latest verified packet: observation sample-path source endpoint for the
...
Immediate predecessor packet: observation envelope-average source endpoint for
...
it specializes finite samples to the canonical `samplePath observation`.
...
covariance/Gaussian-coordinate-mean/envelope-average/sample-path routes.
