...
CURRENT    The active /goal frontier is Lemma 2.4.5 for the non-finite-class
           Theorem 2.4.3 route: prove
           VdVWLemma245TextbookReverseCofiltrationHandoff, the
           textbook-display reverse/permutation-symmetric cofiltration theorem
           turning E[‖P_n-P‖_F^* | Σ_{n+1}] ≥ ‖P_{n+1}-P‖_F^* into a.e.
           finite convergence of the centered empirical supremum.  The
           downstream consumer
           ...
           is compiled.  Do not spend the next run on already-closed
           inverse-radius, finite-cover, VC/subgraph, untruncation,
           finite-class, or natural-filtration packaging unless a proof
           attempt shows it directly closes this named blocker.
