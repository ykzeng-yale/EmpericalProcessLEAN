...
Current frontier: Theorem 5.41 now has a compiled observation-score vector
mean source
endpoint
...
fields with `MeasureTheory.eval_integral`. The next proof packet should continue
