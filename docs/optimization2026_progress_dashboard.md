...
- Current manual frontier after local sync to `origin/main` at `5f759ac`
  ...
  The next target is exact ellipsoid image/hvolume packaging for Lemma 6.20,
  while the exact Grünbaum/centroid theorem remains a supplied blocker for exact
  CoGM reporting.
