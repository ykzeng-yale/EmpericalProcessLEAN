...
- Current manual frontier after the 2026-05-05 ellipsoid source packet:
  ...
  rate layer compiles in `StatInference/Optimization/Ellipsoid.lean`, while
  the exact Grünbaum/centroid theorem remains a supplied blocker for exact CoGM
  reporting.
