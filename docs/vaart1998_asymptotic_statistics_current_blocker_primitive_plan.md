...
1. Move one layer closer to a model-facing finite-dimensional statement:
   continue from the observation-score vector mean fixed-`theta0` endpoint toward a concrete
...
Latest verified Vaart frontier before the next packet: the observation-score
...
observation-score vector mean endpoint to a concrete
