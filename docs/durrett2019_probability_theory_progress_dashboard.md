...
16. Durrett Theorem 3.4.10 now has Lemma 3.4.3 product-difference control
    ...
    approximation;
17. next prove the Taylor/Lindeberg one-factor row-sum obligation
...
the max-smallness of row variances, and
