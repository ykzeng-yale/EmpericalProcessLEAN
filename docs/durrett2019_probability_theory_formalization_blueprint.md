...
The current blocker plan contains `Live In-Thread Goal Prompt V233`, the live
...
source surface.  Prioritize closing the final conditional-probability-clock
event split using the V233 square-clock ratio wrapper and existing
conditional-Borel-Cantelli support.  Do not
route back to
