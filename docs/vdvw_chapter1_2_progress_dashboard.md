...
The remaining blocker is the outer-probability continuous-mapping handoff from
`log_cardinality_littleO_n` to random-cardinality Hoeffding-scale convergence,
then final assembly.
