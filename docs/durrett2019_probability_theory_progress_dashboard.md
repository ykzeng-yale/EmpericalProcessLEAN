...
The next target is the predictable reciprocal-transform and variance/integral
source package for `b_n = f(A_n)`, using V204 and V205 as closed support.
