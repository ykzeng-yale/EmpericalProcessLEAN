...
- Manual goal policy: the app-level `/goal` objective text cannot be edited
  ...
  work.
- Current manual frontier after the 2026-05-05 CoGM source wrapper packet:
  ...
  now Lemma 6.20 ellipsoid geometry; the exact Grünbaum/centroid theorem
  remains a supplied blocker for exact CoGM reporting.
...
spine plus source-shaped CoGM Theorem 6.19 wrapper
`chewi619_gap_le_display_rate_of_scaled_candidates`.  The next manual goal
packet should move to Lemma 6.20 ellipsoid geometry: search matrix/PSD/det/inv
APIs first, introduce a source-shaped ellipsoid update interface, and prove the
half-space containment or volume-ratio algebra that can be verified quickly.
