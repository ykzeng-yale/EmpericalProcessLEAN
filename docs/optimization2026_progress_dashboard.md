...
- Manual goal policy: the app-level `/goal` objective text cannot be edited
  ...
  work.
- Current manual frontier after local sync to `origin/main` at `00bae61`
  (`Rebase Chewi optimization manual goal frontier`) with the verified
  ...
  support packet in `StatInference/Optimization/Ellipsoid.lean`:
