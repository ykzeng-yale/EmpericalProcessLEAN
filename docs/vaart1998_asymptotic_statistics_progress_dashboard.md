...
Move next to the coordinate path Taylor wrapper and remove its
...
strong-law/action-bound/law-tail/display-congruence/display-convergence/display-weak-convergence/score-equation-OP/Taylor-zero-OP/absorbing-tightness/derivative-absorbing-tightness/absorbing-source-endpoint/absorbing-empirical-endpoint/absorbing-raw-Taylor-endpoint/absorbing-coordinate-endpoint
