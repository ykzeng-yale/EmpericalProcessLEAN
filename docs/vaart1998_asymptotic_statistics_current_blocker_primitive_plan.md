...
derivative basis-action, centered-product covariance, and coordinate Gaussian
mean route, but keeps an abstract `scoreLaw` and a score-transform law
assumption. The current endpoint instantiates that law as
