...
- Current manual frontier after rebasing local `main` onto `origin/main` at
  ...
  gap wrapper compile.  The next target is the source minimizer/oracle/rate
  instantiation for Theorem 6.21, then the strongly convex Theorem 6.22 and
