...
Route from `Live In-Thread Goal Prompt V135` in
`docs/durrett2019_probability_theory_current_blocker_primitive_plan.md`.
The active theorem lane is Chapter 4.4 martingale maximal inequalities.  The
current frontier is direct Exercise 4.3.11 survival-event equality only if it is
already locally supported; otherwise move to Exercise 4.4.5's conditional
variance variant or the next Chapter 4.4 exercise/theorem packet.
...
The next target is direct Exercise 4.3.11 survival-event equality only if local
support already exists; otherwise move to Exercise 4.4.5's conditional-variance
variant or the next Chapter 4.4 exercise/theorem packet.
...
`E X = 1`, and nonzero-limit endpoint now compile.  Aim at one forward
textbook packet: direct Exercise 4.3.11 survival-event equality if already
supported locally; otherwise Exercise 4.4.5's conditional-variance variant or
the next Chapter 4.4 exercise/theorem packet.
