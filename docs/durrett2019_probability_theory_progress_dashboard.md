...
Route from `Live In-Thread Goal Prompt V211` in
...
finite pathwise clock-sum lift.  The next target is the infinite/summability
package for `b_n = f(A_n)`, using V204-V211 as closed support.
