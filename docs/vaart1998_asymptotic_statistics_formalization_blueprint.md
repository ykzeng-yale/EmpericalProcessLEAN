...
Current frontier: Theorem 5.41 now has a compiled coordinate covariance
source endpoint for the centered-product covariance route
...
It replaces the shared centered-product table `Gamma` and paired
...
`ProbabilityTheory.covariance_eq_sub`. Its immediate predecessor is the
