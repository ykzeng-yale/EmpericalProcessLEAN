...
/-!
# Convergence-in-measure transfer across exact double-score survey identities

This module turns exact finite WDSM survey-identification equalities into
probability-limit transfer rules.  If a centered and scaled target-sample
contrast converges in measure, then the selected inverse-survey-weighted WDSM
contrast converges in measure to the same limit whenever the exact
double-score survey identity holds pointwise.
-/
...
/--
If the scaled and centered target PATE contrast converges in measure, then the
retrospective selected-sample double-score survey weighted PATE contrast
converges in measure to the same limit under the exact finite
survey-identification assumptions.
-/
theorem tendstoInMeasure_retrospectivePATEDoubleScoreWeight_selected_of_target_limit
    ...
    TendstoInMeasure sampleLaw
      (fun index sample =>
        scale index sample *
          ...
          center index sample))
      l limit := by
  refine TendstoInMeasure.congr ?_ (ae_eq_refl _) htargetLimit
  intro index
...
/--
If the target PATE contrast converges in measure, then the retrospective
selected-sample double-score survey weighted PATE contrast converges in measure
to the same limit under the exact finite survey-identification assumptions.
-/
theorem tendstoInMeasure_retrospectivePATEDoubleScoreWeight_selected_contrast_of_target_contrast
    (limit : Sample -> Real)
    (targetSample selectedSample : Index -> Sample -> Finset Unit)
    (cells :
      Index -> Sample ->
    ...
    TendstoInMeasure sampleLaw
      (fun index sample =>
        weightedSampleMeanContrast (selectedSample index sample)
          ...
          (selectedOutcomeT index sample) (selectedOutcomeC index sample))
      l limit := by
  exact tendstoInMeasure_of_forall_eq
...
/--
If the scaled and centered target PATE contrast converges in measure, then the
prospective selected-sample double-score survey weighted PATE contrast
converges in measure to the same limit under the exact finite
survey-identification assumptions.
-/
theorem tendstoInMeasure_prospectivePATEDoubleScoreWeight_selected_of_target_limit
    (scale center : Index -> Sample -> Real)
    (limit : Sample -> Real)
    (targetSample selectedSample : Index -> Sample -> Finset Unit)
    (cells :
...
/--
If the target PATE contrast converges in measure, then the prospective
selected-sample double-score survey weighted PATE contrast converges in measure
to the same limit under the exact finite survey-identification assumptions.
-/
theorem tendstoInMeasure_prospectivePATEDoubleScoreWeight_selected_contrast_of_target_contrast
    (limit : Sample -> Real)
    (targetSample selectedSample : Index -> Sample -> Finset Unit)
    (cells :
      Index -> Sample ->
    ...
    TendstoInMeasure sampleLaw
      ...
      l limit := by
  simpa using
    (tendstoInMeasure_prospectivePATEDoubleScoreWeight_selected_of_target_limit
      (sampleLaw := sampleLaw) (l := l)
      (fun _index _sample => (1 : Real)) (fun _index _sample => (0 : Real))
      limit targetSample selectedSample cells baseWeight targetOutcomeT
...
/--
If the scaled and centered target PATT contrast converges in measure, then the
retrospective selected-sample double-score survey weighted PATT contrast
converges in measure to the same limit under the exact finite
survey-identification assumptions.
-/
theorem tendstoInMeasure_retrospectivePATTDoubleScoreWeight_selected_of_target_limit
    (scale center : Index -> Sample -> Real)
    (limit : Sample -> Real)
    (targetSample selectedSample : Index -> Sample -> Finset Unit)
...
/--
If the target PATT contrast converges in measure, then the retrospective
selected-sample double-score survey weighted PATT contrast converges in measure
to the same limit under the exact finite survey-identification assumptions.
-/
theorem tendstoInMeasure_retrospectivePATTDoubleScoreWeight_selected_contrast_of_target_contrast
    (limit : Sample -> Real)
    (targetSample selectedSample : Index -> Sample -> Finset Unit)
    (cells : Index -> Sample -> Finset (PropensityCell × PATTProgCell))
    (baseWeight : Index -> Sample -> Unit -> Real)
    ...
    TendstoInMeasure sampleLaw
      ...
      l limit := by
  simpa using
    (tendstoInMeasure_retrospectivePATTDoubleScoreWeight_selected_of_target_limit
      (sampleLaw := sampleLaw) (l := l)
      (fun _index _sample => (1 : Real)) (fun _index _sample => (0 : Real))
      limit targetSample selectedSample cells baseWeight
      treatedTargetOutcome targetControlOutcome selectedControlOutcome
      propensityScore controlPrognosticScore treatment samplingIfTreated
      samplingIfControl treatedCellValue controlValue hcoverTarget
...
/--
If the scaled and centered target PATT contrast converges in measure, then the
prospective selected-sample double-score survey weighted PATT contrast
converges in measure to the same limit under the exact finite
survey-identification assumptions.
-/
theorem tendstoInMeasure_prospectivePATTDoubleScoreWeight_selected_of_target_limit
    (scale center : Index -> Sample -> Real)
    (limit : Sample -> Real)
    (targetSample selectedSample : Index -> Sample -> Finset Unit)
    (cells : Index -> Sample -> Finset (PropensityCell × PATTProgCell))
...
/--
If the target PATT contrast converges in measure, then the prospective
selected-sample double-score survey weighted PATT contrast converges in measure
to the same limit under the exact finite survey-identification assumptions.
-/
theorem tendstoInMeasure_prospectivePATTDoubleScoreWeight_selected_contrast_of_target_contrast
    (limit : Sample -> Real)
    (targetSample selectedSample : Index -> Sample -> Finset Unit)
    (cells : Index -> Sample -> Finset (PropensityCell × PATTProgCell))
    (baseWeight : Index -> Sample -> Unit -> Real)
    ...
    TendstoInMeasure sampleLaw
      ...
      l limit := by
  simpa using
    (tendstoInMeasure_prospectivePATTDoubleScoreWeight_selected_of_target_limit
      (sampleLaw := sampleLaw) (l := l)
      (fun _index _sample => (1 : Real)) (fun _index _sample => (0 : Real))
      limit targetSample selectedSample cells baseWeight
      treatedTargetOutcome targetControlOutcome selectedControlOutcome
      propensityScore controlPrognosticScore treatment samplingMass
      treatedCellValue controlValue hcoverTarget hcoverSelected hmassTarget
      hsampling htreatedMass hcontrolMass hscoreMeasTargetT
      hscoreMeasTargetC hscoreMeasSelectedC (by simpa using htargetLimit))
