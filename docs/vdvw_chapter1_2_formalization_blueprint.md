...
| 1.2.2 | Lemma | `..._1-100.md:389` | local-layer: nonnegative sup/add/inf/product, two-sided constant addition equality, threshold-indicator, and measurable-left inf-equality cover algebra |
