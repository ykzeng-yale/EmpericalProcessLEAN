...
Route from `Live In-Thread Goal Prompt V203` in
`docs/durrett2019_probability_theory_current_blocker_primitive_plan.md`.
The active theorem lane is Durrett Section 4.5.2 in
...
auto endpoints have no manual `hStoppedA_predictable` side condition.  The
next target is exact textbook-facing Theorem 4.5.2 source packaging, then the
next Section 4.5 theorem.
