...
Route from `Live In-Thread Goal Prompt V205` in
...
nonnegative/upper-bound support from `f(A_n) >= 1`.  The next target is the
transform-convergence and variance/integral source package for `b_n = f(A_n)`,
using V204 and V205 as closed support.
