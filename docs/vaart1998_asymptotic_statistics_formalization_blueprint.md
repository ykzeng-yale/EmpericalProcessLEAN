...
mean-zero statement. The efficient route should now prefer this
covariance-bilinear interface over the centered-product/Gamma display unless a
specific source theorem asks for that display.
