...
coordinate covariance route, observation-level score covariance route, or
...
This predecessor still asks for coordinatewise Gaussian-limit mean-zero. The
current endpoint derives it from the vector mean-zero source.
