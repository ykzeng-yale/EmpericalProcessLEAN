...
Route from `Live In-Thread Goal Prompt V62` in
...
finite product-law `withDensity` identity.  The next target is the
infinite-product cylinder/restriction handoff for Kakutani's dichotomy.
