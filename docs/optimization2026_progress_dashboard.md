...
weighted stochastic averaged iterate.
...
source-shaped stochastic averaged iterate.  Next prove any exact source
conditional-expectation/process packaging that is still needed, and final
smooth/non-smooth source-shaped Chewi Theorem 12.1 wrappers combining those
fields with the compiled sampled endpoints and weightedSampleAverage bridge.
...
and final smooth/non-smooth source wrappers.
