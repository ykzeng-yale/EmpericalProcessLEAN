...
The current blocker plan contains `Live In-Thread Goal Prompt V482`, the live
`/goal` replacement prompt.  Use it when the app-level objective is older than
the verified route docs; do not create a duplicate goal or recurring
automation.

Current immediate target after V482: stay on Durrett Theorem 2.4.9
...
products and iid powers.  The next packet should close only a proved-missing
...
the law-side real `ENNReal.ofReal` branch, unless a focused source check
