...
Latest verified packet: Gaussian-limit vector mean source
...
Immediate predecessor packet: observation-score vector mean source
endpoint for the score-at-theta0/Taylor route, including
...
Current next blocker: continue from the Gaussian-limit vector mean
