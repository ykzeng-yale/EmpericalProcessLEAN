...
Route from `Live In-Thread Goal Prompt V136` in
`docs/durrett2019_probability_theory_current_blocker_primitive_plan.md`.
The active theorem lane is Chapter 4.4 martingale maximal inequalities.  The
current frontier is Exercise 4.4.6's bounded-increment small-ball variance
bound, or a nearby Chapter 4.4 theorem-sized packet if that route is blocked.
Treat compiled Chapter 2, Chapter 3, Chapter 4.1
through Theorem 4.1.15, Chapter 4.2, Chapter 4.3, Theorem 4.4.2, Example 4.4.3,
Theorems 4.4.4, 4.4.6, 4.4.7, and 4.4.8, Exercise 4.4.5, and Example 4.4.9 as
closed support.  The
...
The next target is Exercise 4.4.6's bounded-increment small-ball variance bound,
or a nearby Chapter 4.4 theorem-sized packet if that route is blocked.
...
conditional-variance variant now compiles.  Aim at one forward textbook packet:
Exercise 4.4.6's bounded-increment small-ball variance bound, or a nearby
