...
1. Move one layer closer to a model-facing finite-dimensional statement:
   continue from the derivative-transform coordinate-integrability fixed-`theta0` endpoint toward a concrete
...
Latest verified Vaart frontier before the next packet: the derivative-transform
coordinate-integrability source endpoint for Vaart Theorem 5.41.
...
derivative-transform coordinate-integrability endpoint to a concrete
