...
Route from `Live In-Thread Goal Prompt V111` in
...
Doob maximal inequality wrappers.  The next target is the remaining textbook
display for Theorem 4.4.2, Example 4.4.3 Kolmogorov maximal inequality, or
Theorem 4.4.4 Lp maximal inequality.
...
nonnegative/positive-part Doob maximal inequality wrappers.  Aim at one
forward textbook packet: finish the remaining 4.4.2 display if immediate, then
Example 4.4.3 Kolmogorov maximal inequality or Theorem 4.4.4 Lp maximal
inequality.
