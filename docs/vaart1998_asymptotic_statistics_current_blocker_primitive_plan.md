...
1. Move one layer closer to a model-facing finite-dimensional statement:
   continue from the derivative-transform coordinate-measurability fixed-`theta0` endpoint toward a concrete
...
derivative-transform coordinate-measurability endpoint to a concrete
