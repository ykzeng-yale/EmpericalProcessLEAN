...
Latest verified packet: observation transform-display source endpoint for the
...
Immediate predecessor packet: observation sample-path source endpoint for the
score-at-theta0/Taylor route, including
