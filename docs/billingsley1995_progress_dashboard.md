...
4. Check the current VdV&W Theorem 2.4.3 blocker before adding Billingsley
   ...
   mean-zero bridge are now compiled; the latest empirical-process frontier is
   the product/Fubini `Phi(x)=x` symmetrization inequality,
