...
Route from `Live In-Thread Goal Prompt V227` in
...
The next target is the Theorem 4.5.3 specialization to `f(t)=max t 1` using
the V226 clock domination.
