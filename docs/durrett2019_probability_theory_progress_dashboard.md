...
Route from `Live In-Thread Goal Prompt V206` in
...
directly.  The next target is the variance/integral source package for
`b_n = f(A_n)`, using V204-V206 as closed support.
