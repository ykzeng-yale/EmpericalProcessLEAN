...
1. Move one layer closer to a model-facing finite-dimensional statement:
   continue from the Gaussian-limit vector mean fixed-`theta0` endpoint toward a concrete
...
vector mean source endpoint for Vaart Theorem 5.41.
...
Gaussian-limit vector mean endpoint to a concrete
