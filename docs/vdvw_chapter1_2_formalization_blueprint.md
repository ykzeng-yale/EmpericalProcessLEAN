...
| 1.2.4 | Lemma | `..._1-100.md:446` | local-layer: nonnegative a.e.-measurable dominated common-cover core compiled as `VdVWMeasurableCover.ofAEMeasurable_ae_eq`, `.ofAEMeasurable_minimal_ae_of_absolutelyContinuous`, and `.ofAEMeasurableDominated`; full arbitrary extended-real common-cover existence still pending |
