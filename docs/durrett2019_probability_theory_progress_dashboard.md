...
2. construct a `SuppliedRealMiddleCDFPartitionChain` for every bounded
   interval and positive radius, then feed the compiled cutpoint-chain-to-GC
   handoff;
...
- advance Durrett Theorem 2.4.9 by constructing
  ...
  and positive radii, beyond the compiled one-cell/two-cell/right-append and
  cutpoint-chain-to-GC consumers; or
