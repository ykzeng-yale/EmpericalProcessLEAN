...
measurability for the score transform, full vector-valued measurability for
the derivative transform, vector-valued observation integrability plus a
single vector-valued observation derivative
...
coordinatewise derivative measurability via `continuous_apply`, rebuilds
...
derivative-measurability or derivative-integrability sources unless a source
