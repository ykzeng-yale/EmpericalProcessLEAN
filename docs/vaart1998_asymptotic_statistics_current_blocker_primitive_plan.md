...
`vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_scoreTransformMapLawSource_scoreTransformCoordinateMomentSource_derivativeAtTheta0TransformSource_zGaussianMeasurableModificationSource_vDerivativeTransformObservationMeanSource_derivativeTransformCoordinateIntegrableSource_derivativeTransformCoordinateMeasurableSource_scoreTransformCoordinateMeasurableSource_zSampleObservationScoreCenteredProductCovarianceSource_zCoordinateMeanSource_observationSequenceEvalSource_jointMeasurableSource_nonnegativeEnvelopeSource_unscaledScoreSource_fixedTheta0Source_coordinateSumRootSource_univSmoothnessSource_observationEnvelopeMeanSource_observationTransformDisplaySource_observationRandomSequenceTransformMomentSource_observationSamplePathSource_observationEnvelopeAverageSource_observationScoreCovarianceSource_zSampleCoordinateMeanSource_derivativeBasisMatrixActionSource_zSampleMeanSource_scoreVectorMeanSource_scoreLawMeanSource_zGaussianMemLpSource_zLawCovarianceBilinSource_zLawMeanSource_derivativeLawVectorIntegrableSource_scoreLawVectorMomentSource_coordinateProjectionSource_derivativeTableVectorScoreDirectSource_scoreLawCovarianceMomentSource_scoreVectorDisplaySource_estimatingMapContDiffTaylorSource_pointwiseSmoothnessSource_populationBasisMatrixActionSource_pointwiseDerivativeMatrixActionSource_measurableSource_rawRootSource_estimatorDefinitionSource_vectorScoreCommonLawScoreCLT_absorbingSource_envelope`.
...
sample mean-zero facts for the Gaussian limit representative `Z`; and only the textbook
...
derivative-transform measurability, replaces ordinary measurability of `Z` by
the measurable modification from `HasGaussianLaw.aemeasurable.mk`, transports
coordinate means and centered products across the a.e. equality, transfers the
limit back with `TendstoInDistribution.congr`, rebuilds sample vector mean-zero
of `Z` from coordinatewise sample means via
...
`vaart1998_derivativeTransform_vector_mean_of_observation_basis_action`. It derives
...
`vaart1998_theorem_5_41_zEstimator_scaledEstimator_handoff_of_empiricalAverage_scoreTransformMapLawSource_scoreTransformCoordinateMomentSource_derivativeAtTheta0TransformSource_zCoordinateMeasurableSource_vDerivativeTransformObservationMeanSource_derivativeTransformCoordinateIntegrableSource_derivativeTransformCoordinateMeasurableSource_scoreTransformCoordinateMeasurableSource_zSampleObservationScoreCenteredProductCovarianceSource_zCoordinateMeanSource_observationSequenceEvalSource_jointMeasurableSource_nonnegativeEnvelopeSource_unscaledScoreSource_fixedTheta0Source_coordinateSumRootSource_univSmoothnessSource_observationEnvelopeMeanSource_observationTransformDisplaySource_observationRandomSequenceTransformMomentSource_observationSamplePathSource_observationEnvelopeAverageSource_observationScoreCovarianceSource_zSampleCoordinateMeanSource_derivativeBasisMatrixActionSource_zSampleMeanSource_scoreVectorMeanSource_scoreLawMeanSource_zGaussianMemLpSource_zLawCovarianceBilinSource_zLawMeanSource_derivativeLawVectorIntegrableSource_scoreLawVectorMomentSource_coordinateProjectionSource_derivativeTableVectorScoreDirectSource_scoreLawCovarianceMomentSource_scoreVectorDisplaySource_estimatingMapContDiffTaylorSource_pointwiseSmoothnessSource_populationBasisMatrixActionSource_pointwiseDerivativeMatrixActionSource_measurableSource_rawRootSource_estimatorDefinitionSource_vectorScoreCommonLawScoreCLT_absorbingSource_envelope`.

This endpoint uses the same score-transform map-law, coordinate score-transform
moment, observation derivative basis-action, centered-product covariance, and
coordinate Gaussian mean route, but keeps ordinary coordinate measurability of
`Z` as an assumption. The current endpoint replaces that field by a measurable
modification supplied by `HasGaussianLaw.aemeasurable`.
