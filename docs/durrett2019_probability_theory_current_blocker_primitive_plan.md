...
## Live In-Thread Goal Prompt V112
...
Next target: Example 4.4.3 Kolmogorov maximal inequality or Theorem 4.4.4 Lp
maximal inequality.  Do not detour back into full Galton-Watson random-sum
...
inequality wrappers.  Next move to Example 4.4.3 Kolmogorov maximal inequality
or Theorem 4.4.4 Lp maximal inequality, whichever gives the largest compiled
...
Use `Live In-Thread Goal Prompt V112` at the top of this file.  Historical route
