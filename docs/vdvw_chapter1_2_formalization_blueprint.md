...
3. Promote Chapter 2 primitive infrastructure: covering/packing semimetric
   ...
   The outer-probability entropy-to-Hoeffding-scale handoff and
   fixed/all-entropy consumers are now compiled; the next frontier is
   fixed-`M` truncated convergence and final assembly.
