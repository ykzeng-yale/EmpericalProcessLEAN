...
## Live In-Thread Goal Prompt V356
...
Latest verified target V356 adds the projected-characteristic-function CLT
consumers
...
Gaussian ordinary characteristic-function bridge, or the V356 covariance-table
projected-characteristic CLT consumers.  Next aggressive packet:
...
Use `Live In-Thread Goal Prompt V356` at the top of this file.  Historical route
