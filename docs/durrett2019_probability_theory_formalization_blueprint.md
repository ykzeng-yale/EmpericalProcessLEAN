...
The current blocker plan contains `Live In-Thread Goal Prompt V180`, the live
...
independence/product-law wrappers through Theorem 2.1.12's source-facing
independent-pair expectation formulas, Theorem 2.1.15's CDF convolution
