...
Route from `Live In-Thread Goal Prompt V131` in
`docs/durrett2019_probability_theory_current_blocker_primitive_plan.md`.
The active theorem lane is Chapter 4.4 martingale maximal inequalities.  The
current frontier is Example 4.4.9 finite geometric-sum boundedness and `L^2`
convergence support after the compiled conditional and integrated second-moment
recurrence layer.  Treat compiled Chapter 2, Chapter 3, Chapter 4.1
...
The next target is Example 4.4.9 finite geometric-sum boundedness and `L^2`
convergence support.
...
now compiles.  Example 4.4.9's conditional and integrated second-moment
recurrence layer now compiles.  Aim at one forward textbook packet: Example
4.4.9 finite geometric-sum boundedness and `L^2` convergence support.
