...
Route from `Live In-Thread Goal Prompt V46` in
...
Theorem 4.2.12.  The next target is the regular/singular measure identity in
Theorem 4.3.5.
...
martingale/convergence bridge.  Aim at the regular/singular measure identity
using mathlib `withDensity_rnDeriv_eq`, `singularPart`, `rnDeriv_add`,
`rnDeriv_eq_div`, `toReal_rnDeriv_trim`, and set-integral/lintegral convergence
APIs.
