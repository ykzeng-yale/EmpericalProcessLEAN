...
Route from `Live In-Thread Goal Prompt V72` in
...
absolute-continuity branch.  The next target is the actual positive
infinite-product L1/Cauchy estimate, infinite-product criterion support, and
