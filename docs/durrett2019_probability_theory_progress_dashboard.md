...
Route from `Live In-Thread Goal Prompt V117` in
...
The next target is the Fubini/set-integral assembly plus
finite-truncation/monotone-convergence/division algebra that turns these into
the actual positive-part p-th-power estimate feeding the compiled
...
integral bound also compile.  Aim at one forward textbook packet: assemble the
Fubini/set-integral step and finite-truncation/monotone-convergence/division
