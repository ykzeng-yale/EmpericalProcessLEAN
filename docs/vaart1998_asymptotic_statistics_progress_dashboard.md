...
Latest verified packet: observation-sequence evaluation source endpoint for the
...
Immediate predecessor packet: joint-measurability source endpoint for the
score-at-theta0/Taylor route, including
...
measurability of the derivative kernels and the measurable observation
sequence.
...
Current next blocker: continue from the observation-sequence evaluation
