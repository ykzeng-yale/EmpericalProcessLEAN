...
- Manual goal policy: the app-level `/goal` objective text cannot be edited
  ...
  work.
- Current manual frontier after the 2026-05-06 manual-goal rebase, building
  from Optimization route-doc frontier `fab42c1` and verified code frontier
  `4656409` in
  `StatInference/Optimization/AlternatingBregman.lean`: Chapter
  9/10 now has a
  ...
  form.  The active lane is now §11.2, not Corollary 11.3 topology: prove
  Theorem 11.4 via a theorem-sized alternating-minimization scalar
  inverse-gap/telescope packet and supplied source recurrence, then proceed to
