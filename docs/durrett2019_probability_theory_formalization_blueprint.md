...
The current blocker plan contains `Live In-Thread Goal Prompt V19`, the live
...
- The same Markdown chunk contains Chapter 4.2 martingales near line 4348 and
  Example 4.2.1 linear martingales near line 4358.
