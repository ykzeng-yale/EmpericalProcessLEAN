...
Latest verified packet: score-vector coordinate mean source endpoint for the
...
Immediate predecessor packet: coordinate limit-mean source endpoint for the
score-at-theta0/Taylor route, including
...
score-vector display wrappers, or direct vector/table wrappers.
